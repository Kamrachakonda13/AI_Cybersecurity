...
Use it when the security objective matches **Kali security utility: havoc** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **havoc** and read this guide before execution.
...
**One sentence:** havoc is used to help the team achieve **Kali security utility: havoc** under an approved and auditable VEYRA workflow.
