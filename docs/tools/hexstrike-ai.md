...
## What is it?
Kali security utility: hexstrike-ai
...
Use it when the security objective matches **Kali security utility: hexstrike-ai** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **hexstrike-ai** and read this guide before execution.
...
**One sentence:** hexstrike-ai is used to help the team achieve **Kali security utility: hexstrike-ai** under an approved and auditable VEYRA workflow.
