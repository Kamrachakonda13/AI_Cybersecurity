...
## What is it?
Kali security utility: xsrfprobe
...
Use it when the security objective matches **Kali security utility: xsrfprobe** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **xsrfprobe** and read this guide before execution.
...
**One sentence:** xsrfprobe is used to help the team achieve **Kali security utility: xsrfprobe** under an approved and auditable VEYRA workflow.
