...
**Purpose:** Controlled vulnerable-agent security training corpus  
**VEYRA access:** admin  
**Execution boundary:** isolated_lab_only

## What is it?
Controlled vulnerable-agent security training corpus
...
Use it when the security objective matches **Controlled vulnerable-agent security training corpus** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **OWASP Agentic Security Initiative Samples** and read this guide before execution.
...
```bash
OWASP Agentic Security Initiative Samples --help
OWASP Agentic Security Initiative Samples --version
```
...
**One sentence:** OWASP Agentic Security Initiative Samples is used to help the team achieve **Controlled vulnerable-agent security training corpus** under an approved and auditable VEYRA workflow.
