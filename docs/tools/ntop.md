...
## What is it?
Advanced network discovery capability: Ntop
...
Use it when the security objective matches **Advanced network discovery capability: Ntop** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Ntop** and read this guide before execution.
...
**One sentence:** Ntop is used to help the team achieve **Advanced network discovery capability: Ntop** under an approved and auditable VEYRA workflow.
