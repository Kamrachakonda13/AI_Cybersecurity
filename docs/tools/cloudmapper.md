...
## What is it?
Advanced cloud capability: CloudMapper
...
Use it when the security objective matches **Advanced cloud capability: CloudMapper** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **CloudMapper** and read this guide before execution.
...
**One sentence:** CloudMapper is used to help the team achieve **Advanced cloud capability: CloudMapper** under an approved and auditable VEYRA workflow.
