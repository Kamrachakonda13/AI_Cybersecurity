...
## What is it?
Kali security utility: evil-ssdp
...
Use it when the security objective matches **Kali security utility: evil-ssdp** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **evil-ssdp** and read this guide before execution.
...
**One sentence:** evil-ssdp is used to help the team achieve **Kali security utility: evil-ssdp** under an approved and auditable VEYRA workflow.
