...
## What is it?
Kali security utility: sickle-pdk
...
Use it when the security objective matches **Kali security utility: sickle-pdk** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **sickle-pdk** and read this guide before execution.
...
**One sentence:** sickle-pdk is used to help the team achieve **Kali security utility: sickle-pdk** under an approved and auditable VEYRA workflow.
