...
**Purpose:** Retrieval security integration candidate  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Retrieval security integration candidate
...
Use it when the security objective matches **Retrieval security integration candidate** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **nemo-retriever** and read this guide before execution.
...
**One sentence:** nemo-retriever is used to help the team achieve **Retrieval security integration candidate** under an approved and auditable VEYRA workflow.
