...
## What is it?
Kali security utility: sharphound
...
Use it when the security objective matches **Kali security utility: sharphound** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** sharphound is used to help the team achieve **Kali security utility: sharphound** under an approved and auditable VEYRA workflow.
