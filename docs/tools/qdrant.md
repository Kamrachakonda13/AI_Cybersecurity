...
2. Search for **Qdrant** and read this guide before execution.
...
**One sentence:** Qdrant is used to help the team achieve **Vector database integration and security testing** under an approved and auditable VEYRA workflow.
