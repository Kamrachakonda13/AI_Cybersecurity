...
**Purpose:** SLSA provenance and build integrity  
**VEYRA access:** admin  
...
Use it when the security objective matches **SLSA provenance and build integrity** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** slsa is used to help the team achieve **SLSA provenance and build integrity** under an approved and auditable VEYRA workflow.
