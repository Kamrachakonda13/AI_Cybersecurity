...
## What is it?
Kali security utility: python3-ldapdomaindump
...
Use it when the security objective matches **Kali security utility: python3-ldapdomaindump** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **python3-ldapdomaindump** and read this guide before execution.
...
```bash
python3-ldapdomaindump --help
python3-ldapdomaindump --version
```
...
**One sentence:** python3-ldapdomaindump is used to help the team achieve **Kali security utility: python3-ldapdomaindump** under an approved and auditable VEYRA workflow.
