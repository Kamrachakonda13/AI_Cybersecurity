...
Use it when the security objective matches **CSPM/security auditing** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Prowler** and read this guide before execution.
...
**One sentence:** Prowler is used to help the team achieve **CSPM/security auditing** under an approved and auditable VEYRA workflow.
