...
## What is it?
Kali security utility: dufflebag
...
Use it when the security objective matches **Kali security utility: dufflebag** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **dufflebag** and read this guide before execution.
...
**One sentence:** dufflebag is used to help the team achieve **Kali security utility: dufflebag** under an approved and auditable VEYRA workflow.
