...
Use it when the security objective matches **Web application security assessment** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Burp Suite** and read this guide before execution.
...
**One sentence:** Burp Suite is used to help the team achieve **Web application security assessment** under an approved and auditable VEYRA workflow.
