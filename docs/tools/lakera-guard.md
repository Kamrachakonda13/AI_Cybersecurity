...
**Purpose:** Prompt/data security and threat detection integration  
**VEYRA access:** admin  
**Execution boundary:** approved_connector

## What is it?
Prompt/data security and threat detection integration
...
Use it when the security objective matches **Prompt/data security and threat detection integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Lakera Guard** and read this guide before execution.
...
**One sentence:** Lakera Guard is used to help the team achieve **Prompt/data security and threat detection integration** under an approved and auditable VEYRA workflow.
