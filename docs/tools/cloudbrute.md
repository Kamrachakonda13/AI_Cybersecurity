...
## What is it?
Kali security utility: cloudbrute
...
Use it when the security objective matches **Kali security utility: cloudbrute** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **cloudbrute** and read this guide before execution.
...
**One sentence:** cloudbrute is used to help the team achieve **Kali security utility: cloudbrute** under an approved and auditable VEYRA workflow.
