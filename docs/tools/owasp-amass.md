...
## What is it?
Advanced attack surface capability: OWASP Amass
...
Use it when the security objective matches **Advanced attack surface capability: OWASP Amass** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **OWASP Amass** and read this guide before execution.
...
**One sentence:** OWASP Amass is used to help the team achieve **Advanced attack surface capability: OWASP Amass** under an approved and auditable VEYRA workflow.
