...
**Purpose:** ML experiment/model governance connector  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
ML experiment/model governance connector
...
Use it when the security objective matches **ML experiment/model governance connector** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **wandb** and read this guide before execution.
...
**One sentence:** wandb is used to help the team achieve **ML experiment/model governance connector** under an approved and auditable VEYRA workflow.
