...
## What is it?
Kali security utility: maltego-teeth
...
Use it when the security objective matches **Kali security utility: maltego-teeth** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **maltego-teeth** and read this guide before execution.
...
**One sentence:** maltego-teeth is used to help the team achieve **Kali security utility: maltego-teeth** under an approved and auditable VEYRA workflow.
