...
## What is it?
Advanced cloud capability: Steampipe
...
Use it when the security objective matches **Advanced cloud capability: Steampipe** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Steampipe** and read this guide before execution.
...
**One sentence:** Steampipe is used to help the team achieve **Advanced cloud capability: Steampipe** under an approved and auditable VEYRA workflow.
