...
## What is it?
Kali security utility: bloodyad
...
Use it when the security objective matches **Kali security utility: bloodyad** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** bloodyad is used to help the team achieve **Kali security utility: bloodyad** under an approved and auditable VEYRA workflow.
