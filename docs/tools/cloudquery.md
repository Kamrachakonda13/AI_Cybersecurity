...
## What is it?
Advanced cloud capability: CloudQuery
...
Use it when the security objective matches **Advanced cloud capability: CloudQuery** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **CloudQuery** and read this guide before execution.
...
**One sentence:** CloudQuery is used to help the team achieve **Advanced cloud capability: CloudQuery** under an approved and auditable VEYRA workflow.
