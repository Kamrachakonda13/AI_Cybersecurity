...
## What is it?
Advanced network discovery capability: Netdisco
...
Use it when the security objective matches **Advanced network discovery capability: Netdisco** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Netdisco** and read this guide before execution.
...
**One sentence:** Netdisco is used to help the team achieve **Advanced network discovery capability: Netdisco** under an approved and auditable VEYRA workflow.
