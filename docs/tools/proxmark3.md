...
## What is it?
Kali security utility: proxmark3
...
Use it when the security objective matches **Kali security utility: proxmark3** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** proxmark3 is used to help the team achieve **Kali security utility: proxmark3** under an approved and auditable VEYRA workflow.
