...
**Purpose:** MCP policy, tool and transport security integration  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
MCP policy, tool and transport security integration
...
Use it when the security objective matches **MCP policy, tool and transport security integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **mcp-security** and read this guide before execution.
...
**One sentence:** mcp-security is used to help the team achieve **MCP policy, tool and transport security integration** under an approved and auditable VEYRA workflow.
