...
## What is it?
Kali security utility: unhide.rb
...
Use it when the security objective matches **Kali security utility: unhide.rb** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **unhide.rb** and read this guide before execution.
...
**One sentence:** unhide.rb is used to help the team achieve **Kali security utility: unhide.rb** under an approved and auditable VEYRA workflow.
