...
## What is it?
Advanced security utilities capability: ART
...
Use it when the security objective matches **Advanced security utilities capability: ART** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ART** and read this guide before execution.
...
**One sentence:** ART is used to help the team achieve **Advanced security utilities capability: ART** under an approved and auditable VEYRA workflow.
