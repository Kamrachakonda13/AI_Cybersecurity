...
## What is it?
Advanced identity capability: PingCastle
...
Use it when the security objective matches **Advanced identity capability: PingCastle** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **PingCastle** and read this guide before execution.
...
**One sentence:** PingCastle is used to help the team achieve **Advanced identity capability: PingCastle** under an approved and auditable VEYRA workflow.
