...
## What is it?
Advanced kubernetes capability: KubeLinter
...
Use it when the security objective matches **Advanced kubernetes capability: KubeLinter** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **KubeLinter** and read this guide before execution.
...
**One sentence:** KubeLinter is used to help the team achieve **Advanced kubernetes capability: KubeLinter** under an approved and auditable VEYRA workflow.
