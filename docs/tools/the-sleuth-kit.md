...
## What is it?
Advanced dfir capability: The Sleuth Kit
...
Use it when the security objective matches **Advanced dfir capability: The Sleuth Kit** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **The Sleuth Kit** and read this guide before execution.
...
**One sentence:** The Sleuth Kit is used to help the team achieve **Advanced dfir capability: The Sleuth Kit** under an approved and auditable VEYRA workflow.
