...
## What is it?
Kali security utility: dislocker
...
Use it when the security objective matches **Kali security utility: dislocker** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **dislocker** and read this guide before execution.
...
**One sentence:** dislocker is used to help the team achieve **Kali security utility: dislocker** under an approved and auditable VEYRA workflow.
