...
## What is it?
Advanced identity capability: ADRecon
...
Use it when the security objective matches **Advanced identity capability: ADRecon** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ADRecon** and read this guide before execution.
...
**One sentence:** ADRecon is used to help the team achieve **Advanced identity capability: ADRecon** under an approved and auditable VEYRA workflow.
