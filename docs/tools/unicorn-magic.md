...
## What is it?
Kali security utility: unicorn-magic
...
Use it when the security objective matches **Kali security utility: unicorn-magic** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **unicorn-magic** and read this guide before execution.
...
**One sentence:** unicorn-magic is used to help the team achieve **Kali security utility: unicorn-magic** under an approved and auditable VEYRA workflow.
