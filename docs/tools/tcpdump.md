...
Use it when the security objective matches **Packet capture** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **tcpdump** and read this guide before execution.
...
**One sentence:** tcpdump is used to help the team achieve **Packet capture** under an approved and auditable VEYRA workflow.
