...
**Purpose:** Supply-chain provenance and build integrity controls  
**VEYRA access:** admin  
**Execution boundary:** approved_worker

## What is it?
Supply-chain provenance and build integrity controls
...
Use it when the security objective matches **Supply-chain provenance and build integrity controls** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **SLSA** and read this guide before execution.
...
**One sentence:** SLSA is used to help the team achieve **Supply-chain provenance and build integrity controls** under an approved and auditable VEYRA workflow.
