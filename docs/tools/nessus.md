...
## What is it?
Vulnerability assessment/import
...
Use it when the security objective matches **Vulnerability assessment/import** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Nessus** and read this guide before execution.
...
**One sentence:** Nessus is used to help the team achieve **Vulnerability assessment/import** under an approved and auditable VEYRA workflow.
