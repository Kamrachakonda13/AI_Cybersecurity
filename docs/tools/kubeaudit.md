...
## What is it?
Advanced kubernetes capability: kubeaudit
...
Use it when the security objective matches **Advanced kubernetes capability: kubeaudit** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **kubeaudit** and read this guide before execution.
...
**One sentence:** kubeaudit is used to help the team achieve **Advanced kubernetes capability: kubeaudit** under an approved and auditable VEYRA workflow.
