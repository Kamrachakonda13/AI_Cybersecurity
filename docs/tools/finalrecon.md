...
## What is it?
Kali security utility: finalrecon
...
Use it when the security objective matches **Kali security utility: finalrecon** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **finalrecon** and read this guide before execution.
...
**One sentence:** finalrecon is used to help the team achieve **Kali security utility: finalrecon** under an approved and auditable VEYRA workflow.
