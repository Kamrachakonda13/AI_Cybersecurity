...
**Purpose:** AI artifact vulnerability scanning integration  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
AI artifact vulnerability scanning integration
...
Use it when the security objective matches **AI artifact vulnerability scanning integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **grype-ml** and read this guide before execution.
...
**One sentence:** grype-ml is used to help the team achieve **AI artifact vulnerability scanning integration** under an approved and auditable VEYRA workflow.
