...
## What is it?
Advanced ai security capability: Aircrack-ng
...
Use it when the security objective matches **Advanced ai security capability: Aircrack-ng** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Aircrack-ng** and read this guide before execution.
...
**One sentence:** Aircrack-ng is used to help the team achieve **Advanced ai security capability: Aircrack-ng** under an approved and auditable VEYRA workflow.
