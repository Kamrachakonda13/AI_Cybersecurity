...
## What is it?
Kali security utility: portspoof
...
Use it when the security objective matches **Kali security utility: portspoof** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **portspoof** and read this guide before execution.
...
**One sentence:** portspoof is used to help the team achieve **Kali security utility: portspoof** under an approved and auditable VEYRA workflow.
