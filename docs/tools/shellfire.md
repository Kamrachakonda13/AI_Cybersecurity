...
## What is it?
Kali security utility: shellfire
...
Use it when the security objective matches **Kali security utility: shellfire** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **shellfire** and read this guide before execution.
...
**One sentence:** shellfire is used to help the team achieve **Kali security utility: shellfire** under an approved and auditable VEYRA workflow.
