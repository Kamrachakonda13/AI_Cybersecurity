...
**Purpose:** Agent/tool-use benchmark integration candidate  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Agent/tool-use benchmark integration candidate
...
Use it when the security objective matches **Agent/tool-use benchmark integration candidate** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **tango-bench** and read this guide before execution.
...
**One sentence:** tango-bench is used to help the team achieve **Agent/tool-use benchmark integration candidate** under an approved and auditable VEYRA workflow.
