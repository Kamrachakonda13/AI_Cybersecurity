...
**Purpose:** Holistic language-model evaluation and benchmarking  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Holistic language-model evaluation and benchmarking
...
Use it when the security objective matches **Holistic language-model evaluation and benchmarking** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **HELM** and read this guide before execution.
...
**One sentence:** HELM is used to help the team achieve **Holistic language-model evaluation and benchmarking** under an approved and auditable VEYRA workflow.
