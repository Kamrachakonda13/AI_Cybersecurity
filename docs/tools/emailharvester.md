...
## What is it?
Kali security utility: emailharvester
...
Use it when the security objective matches **Kali security utility: emailharvester** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **emailharvester** and read this guide before execution.
...
**One sentence:** emailharvester is used to help the team achieve **Kali security utility: emailharvester** under an approved and auditable VEYRA workflow.
