...
Use it when the security objective matches **Kali security utility: ligolo-ng-common-binaries** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ligolo-ng-common-binaries** and read this guide before execution.
...
```bash
ligolo-ng-common-binaries --help
ligolo-ng-common-binaries --version
```
...
**One sentence:** ligolo-ng-common-binaries is used to help the team achieve **Kali security utility: ligolo-ng-common-binaries** under an approved and auditable VEYRA workflow.
