...
**Purpose:** Isolated agent execution environment integration  
**VEYRA access:** privileged_admin  
**Execution boundary:** isolated_ai_worker

## What is it?
Isolated agent execution environment integration
...
Use it when the security objective matches **Isolated agent execution environment integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **agent-sandbox** and read this guide before execution.
...
**One sentence:** agent-sandbox is used to help the team achieve **Isolated agent execution environment integration** under an approved and auditable VEYRA workflow.
