...
2. Search for **Milvus** and read this guide before execution.
...
**One sentence:** Milvus is used to help the team achieve **Vector database integration and security testing** under an approved and auditable VEYRA workflow.
