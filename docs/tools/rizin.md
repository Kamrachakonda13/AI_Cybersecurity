...
2. Search for **Rizin** and read this guide before execution.
...
**One sentence:** Rizin is used to help the team achieve **Static reverse engineering** under an approved and auditable VEYRA workflow.
