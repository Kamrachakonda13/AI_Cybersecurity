...
Use it when the security objective matches **Static reverse engineering** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **radare2** and read this guide before execution.
...
**One sentence:** radare2 is used to help the team achieve **Static reverse engineering** under an approved and auditable VEYRA workflow.
