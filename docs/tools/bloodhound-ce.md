...
## What is it?
Advanced identity capability: BloodHound CE
...
Use it when the security objective matches **Advanced identity capability: BloodHound CE** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **BloodHound CE** and read this guide before execution.
...
**One sentence:** BloodHound CE is used to help the team achieve **Advanced identity capability: BloodHound CE** under an approved and auditable VEYRA workflow.
