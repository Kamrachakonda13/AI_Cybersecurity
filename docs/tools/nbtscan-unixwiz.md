...
## What is it?
Kali security utility: nbtscan-unixwiz
...
Use it when the security objective matches **Kali security utility: nbtscan-unixwiz** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **nbtscan-unixwiz** and read this guide before execution.
...
**One sentence:** nbtscan-unixwiz is used to help the team achieve **Kali security utility: nbtscan-unixwiz** under an approved and auditable VEYRA workflow.
