...
**Category:** Vector DB  
**Purpose:** Managed vector database security connector  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Managed vector database security connector
...
Use it when the security objective matches **Managed vector database security connector** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **pinecone** and read this guide before execution.
...
**One sentence:** pinecone is used to help the team achieve **Managed vector database security connector** under an approved and auditable VEYRA workflow.
