...
## What is it?
Advanced appsec capability: DefectDojo
...
Use it when the security objective matches **Advanced appsec capability: DefectDojo** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **DefectDojo** and read this guide before execution.
...
**One sentence:** DefectDojo is used to help the team achieve **Advanced appsec capability: DefectDojo** under an approved and auditable VEYRA workflow.
