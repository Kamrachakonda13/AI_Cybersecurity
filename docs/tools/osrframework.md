...
## What is it?
Kali security utility: osrframework
...
Use it when the security objective matches **Kali security utility: osrframework** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **osrframework** and read this guide before execution.
...
**One sentence:** osrframework is used to help the team achieve **Kali security utility: osrframework** under an approved and auditable VEYRA workflow.
