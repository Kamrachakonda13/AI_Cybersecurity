...
## What is it?
Advanced security utilities capability: PetitPotam
...
Use it when the security objective matches **Advanced security utilities capability: PetitPotam** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **PetitPotam** and read this guide before execution.
...
**One sentence:** PetitPotam is used to help the team achieve **Advanced security utilities capability: PetitPotam** under an approved and auditable VEYRA workflow.
