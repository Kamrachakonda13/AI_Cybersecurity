...
## What is it?
Kali security utility: websploit
...
Use it when the security objective matches **Kali security utility: websploit** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **websploit** and read this guide before execution.
...
**One sentence:** websploit is used to help the team achieve **Kali security utility: websploit** under an approved and auditable VEYRA workflow.
