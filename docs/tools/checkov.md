...
2. Search for **Checkov** and read this guide before execution.
...
**One sentence:** Checkov is used to help the team achieve **Infrastructure-as-code security** under an approved and auditable VEYRA workflow.
