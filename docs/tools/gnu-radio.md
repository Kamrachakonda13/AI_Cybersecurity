...
## What is it?
Advanced security utilities capability: GNU Radio
...
Use it when the security objective matches **Advanced security utilities capability: GNU Radio** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **GNU Radio** and read this guide before execution.
...
**One sentence:** GNU Radio is used to help the team achieve **Advanced security utilities capability: GNU Radio** under an approved and auditable VEYRA workflow.
