...
## What is it?
Advanced cloud capability: Pacu
...
Use it when the security objective matches **Advanced cloud capability: Pacu** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Pacu** and read this guide before execution.
...
**One sentence:** Pacu is used to help the team achieve **Advanced cloud capability: Pacu** under an approved and auditable VEYRA workflow.
