...
## What is it?
Kali security utility: hekatomb
...
Use it when the security objective matches **Kali security utility: hekatomb** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **hekatomb** and read this guide before execution.
...
**One sentence:** hekatomb is used to help the team achieve **Kali security utility: hekatomb** under an approved and auditable VEYRA workflow.
