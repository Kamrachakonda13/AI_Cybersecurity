...
## What is it?
Kali security utility: slimtoolkit
...
Use it when the security objective matches **Kali security utility: slimtoolkit** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **slimtoolkit** and read this guide before execution.
...
**One sentence:** slimtoolkit is used to help the team achieve **Kali security utility: slimtoolkit** under an approved and auditable VEYRA workflow.
