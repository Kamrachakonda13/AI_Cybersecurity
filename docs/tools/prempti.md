...
**Purpose:** Experimental runtime visibility and policy for AI-agent tool-call activity  
**VEYRA access:** admin  
**Execution boundary:** experimental_worker

## What is it?
Experimental runtime visibility and policy for AI-agent tool-call activity
...
Use it when the security objective matches **Experimental runtime visibility and policy for AI-agent tool-call activity** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Prempti** and read this guide before execution.
...
**One sentence:** Prempti is used to help the team achieve **Experimental runtime visibility and policy for AI-agent tool-call activity** under an approved and auditable VEYRA workflow.
