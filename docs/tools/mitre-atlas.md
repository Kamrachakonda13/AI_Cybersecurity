...
**Purpose:** AI adversary technique mapping and threat intelligence  
**VEYRA access:** admin  
**Execution boundary:** approved_connector

## What is it?
AI adversary technique mapping and threat intelligence
...
Use it when the security objective matches **AI adversary technique mapping and threat intelligence** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **MITRE ATLAS** and read this guide before execution.
...
**One sentence:** MITRE ATLAS is used to help the team achieve **AI adversary technique mapping and threat intelligence** under an approved and auditable VEYRA workflow.
