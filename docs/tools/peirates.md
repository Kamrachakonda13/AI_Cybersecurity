...
## What is it?
Kali security utility: peirates
...
Use it when the security objective matches **Kali security utility: peirates** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** peirates is used to help the team achieve **Kali security utility: peirates** under an approved and auditable VEYRA workflow.
