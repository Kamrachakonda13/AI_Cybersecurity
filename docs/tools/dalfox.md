...
## What is it?
Advanced web/api capability: Dalfox
...
Use it when the security objective matches **Advanced web/api capability: Dalfox** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Dalfox** and read this guide before execution.
...
**One sentence:** Dalfox is used to help the team achieve **Advanced web/api capability: Dalfox** under an approved and auditable VEYRA workflow.
