...
## What is it?
Advanced dfir capability: Eric Zimmerman Tools
...
Use it when the security objective matches **Advanced dfir capability: Eric Zimmerman Tools** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Eric Zimmerman Tools** and read this guide before execution.
...
```bash
eric-zimmerman-tools --help
eric-zimmerman-tools --version
```
...
**One sentence:** Eric Zimmerman Tools is used to help the team achieve **Advanced dfir capability: Eric Zimmerman Tools** under an approved and auditable VEYRA workflow.
