...
Use it when the security objective matches **Kali security utility: donut** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **donut** and read this guide before execution.
...
**One sentence:** donut is used to help the team achieve **Kali security utility: donut** under an approved and auditable VEYRA workflow.
