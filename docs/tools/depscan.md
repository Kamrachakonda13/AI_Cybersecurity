...
**Purpose:** Dependency/SBOM vulnerability analysis  
**VEYRA access:** admin  
...
Use it when the security objective matches **Dependency/SBOM vulnerability analysis** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **depscan** and read this guide before execution.
...
**One sentence:** depscan is used to help the team achieve **Dependency/SBOM vulnerability analysis** under an approved and auditable VEYRA workflow.
