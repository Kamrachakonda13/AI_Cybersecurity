...
## What is it?
Kali security utility: getsploit
...
Use it when the security objective matches **Kali security utility: getsploit** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **getsploit** and read this guide before execution.
...
**One sentence:** getsploit is used to help the team achieve **Kali security utility: getsploit** under an approved and auditable VEYRA workflow.
