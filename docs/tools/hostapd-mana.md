...
## What is it?
Kali security utility: hostapd-mana
...
Use it when the security objective matches **Kali security utility: hostapd-mana** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** hostapd-mana is used to help the team achieve **Kali security utility: hostapd-mana** under an approved and auditable VEYRA workflow.
