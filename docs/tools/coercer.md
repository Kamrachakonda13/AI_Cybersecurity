...
Use it when the security objective matches **Kali security utility: coercer** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** coercer is used to help the team achieve **Kali security utility: coercer** under an approved and auditable VEYRA workflow.
