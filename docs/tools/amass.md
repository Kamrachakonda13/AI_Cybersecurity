...
Use it when the security objective matches **Asset/domain discovery** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Amass** and read this guide before execution.
...
**One sentence:** Amass is used to help the team achieve **Asset/domain discovery** under an approved and auditable VEYRA workflow.
