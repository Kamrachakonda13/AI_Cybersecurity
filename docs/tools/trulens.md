...
**Purpose:** LLM and RAG evaluation and feedback functions  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
LLM and RAG evaluation and feedback functions
...
Use it when the security objective matches **LLM and RAG evaluation and feedback functions** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **TruLens** and read this guide before execution.
...
**One sentence:** TruLens is used to help the team achieve **LLM and RAG evaluation and feedback functions** under an approved and auditable VEYRA workflow.
