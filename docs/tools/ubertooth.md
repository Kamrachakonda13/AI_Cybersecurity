...
## What is it?
Advanced wireless capability: Ubertooth
...
Use it when the security objective matches **Advanced wireless capability: Ubertooth** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Ubertooth** and read this guide before execution.
...
**One sentence:** Ubertooth is used to help the team achieve **Advanced wireless capability: Ubertooth** under an approved and auditable VEYRA workflow.
