...
## What is it?
Kali security utility: terraform
...
Use it when the security objective matches **Kali security utility: terraform** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **terraform** and read this guide before execution.
...
**One sentence:** terraform is used to help the team achieve **Kali security utility: terraform** under an approved and auditable VEYRA workflow.
