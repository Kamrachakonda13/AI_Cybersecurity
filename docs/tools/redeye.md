...
Use it when the security objective matches **Kali security utility: redeye** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **redeye** and read this guide before execution.
...
**One sentence:** redeye is used to help the team achieve **Kali security utility: redeye** under an approved and auditable VEYRA workflow.
