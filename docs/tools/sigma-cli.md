...
## What is it?
Kali security utility: sigma-cli
...
Use it when the security objective matches **Kali security utility: sigma-cli** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** sigma-cli is used to help the team achieve **Kali security utility: sigma-cli** under an approved and auditable VEYRA workflow.
