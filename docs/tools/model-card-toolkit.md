...
**Purpose:** Model-card governance artifacts  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Model-card governance artifacts
...
Use it when the security objective matches **Model-card governance artifacts** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **model-card-toolkit** and read this guide before execution.
...
**One sentence:** model-card-toolkit is used to help the team achieve **Model-card governance artifacts** under an approved and auditable VEYRA workflow.
