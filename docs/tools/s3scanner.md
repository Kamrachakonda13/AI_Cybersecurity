...
## What is it?
Kali security utility: s3scanner
...
Use it when the security objective matches **Kali security utility: s3scanner** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **s3scanner** and read this guide before execution.
...
**One sentence:** s3scanner is used to help the team achieve **Kali security utility: s3scanner** under an approved and auditable VEYRA workflow.
