...
Use it when the security objective matches **Endpoint telemetry/query** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **osquery** and read this guide before execution.
...
**One sentence:** osquery is used to help the team achieve **Endpoint telemetry/query** under an approved and auditable VEYRA workflow.
