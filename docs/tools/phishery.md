...
## What is it?
Kali security utility: phishery
...
Use it when the security objective matches **Kali security utility: phishery** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **phishery** and read this guide before execution.
...
**One sentence:** phishery is used to help the team achieve **Kali security utility: phishery** under an approved and auditable VEYRA workflow.
