...
## What is it?
Kali security utility: cri-tools
...
Use it when the security objective matches **Kali security utility: cri-tools** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **cri-tools** and read this guide before execution.
...
**One sentence:** cri-tools is used to help the team achieve **Kali security utility: cri-tools** under an approved and auditable VEYRA workflow.
