...
## What is it?
Kali security utility: chainsaw
...
Use it when the security objective matches **Kali security utility: chainsaw** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** chainsaw is used to help the team achieve **Kali security utility: chainsaw** under an approved and auditable VEYRA workflow.
