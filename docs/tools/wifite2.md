...
## What is it?
Advanced wireless capability: Wifite2
...
Use it when the security objective matches **Advanced wireless capability: Wifite2** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Wifite2** and read this guide before execution.
...
**One sentence:** Wifite2 is used to help the team achieve **Advanced wireless capability: Wifite2** under an approved and auditable VEYRA workflow.
