...
Use it when the security objective matches **Advanced dfir capability: KAPE** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **KAPE** and read this guide before execution.
...
**One sentence:** KAPE is used to help the team achieve **Advanced dfir capability: KAPE** under an approved and auditable VEYRA workflow.
