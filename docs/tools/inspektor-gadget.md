...
**Category:** Kubernetes  
**Purpose:** eBPF-based Kubernetes and Linux runtime observability and inspection  
**VEYRA access:** admin  
**Execution boundary:** approved_worker

## What is it?
eBPF-based Kubernetes and Linux runtime observability and inspection
...
Use it when the security objective matches **eBPF-based Kubernetes and Linux runtime observability and inspection** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Inspektor Gadget** and read this guide before execution.
...
**One sentence:** Inspektor Gadget is used to help the team achieve **eBPF-based Kubernetes and Linux runtime observability and inspection** under an approved and auditable VEYRA workflow.
