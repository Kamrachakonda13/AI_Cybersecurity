...
**Category:** AI Gateway  
**Purpose:** Model gateway, routing and centralized policy point  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Model gateway, routing and centralized policy point
...
Use it when the security objective matches **Model gateway, routing and centralized policy point** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **LiteLLM** and read this guide before execution.
...
**One sentence:** LiteLLM is used to help the team achieve **Model gateway, routing and centralized policy point** under an approved and auditable VEYRA workflow.
