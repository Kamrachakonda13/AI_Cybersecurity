...
**Purpose:** Vector store integration and retrieval security testing  
**VEYRA access:** admin  
**Execution boundary:** approved_connector

## What is it?
Vector store integration and retrieval security testing
...
Use it when the security objective matches **Vector store integration and retrieval security testing** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Chroma** and read this guide before execution.
...
**One sentence:** Chroma is used to help the team achieve **Vector store integration and retrieval security testing** under an approved and auditable VEYRA workflow.
