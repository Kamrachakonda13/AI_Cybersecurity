...
Use it when the security objective matches **Kali security utility: wig** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **wig** and read this guide before execution.
...
**One sentence:** wig is used to help the team achieve **Kali security utility: wig** under an approved and auditable VEYRA workflow.
