...
## What is it?
Advanced security utilities capability: OpenSearch Security Analytics
...
Use it when the security objective matches **Advanced security utilities capability: OpenSearch Security Analytics** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **OpenSearch Security Analytics** and read this guide before execution.
...
```bash
OpenSearch Security Analytics --help
OpenSearch Security Analytics --version
```
...
**One sentence:** OpenSearch Security Analytics is used to help the team achieve **Advanced security utilities capability: OpenSearch Security Analytics** under an approved and auditable VEYRA workflow.
