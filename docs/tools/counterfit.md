...
**Purpose:** Adversarial ML assessment framework  
**VEYRA access:** admin  
**Execution boundary:** isolated_analysis_worker

## What is it?
Adversarial ML assessment framework
...
Use it when the security objective matches **Adversarial ML assessment framework** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Counterfit** and read this guide before execution.
...
**One sentence:** Counterfit is used to help the team achieve **Adversarial ML assessment framework** under an approved and auditable VEYRA workflow.
