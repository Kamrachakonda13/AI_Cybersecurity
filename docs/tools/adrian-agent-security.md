# Adrian Agent Security

**Category:** Agent Security  
**Purpose:** Runtime monitoring and intervention for AI-agent actions and tool calls  
**VEYRA access:** admin  
**Execution boundary:** experimental_worker

## What is it?
Runtime monitoring and intervention for AI-agent actions and tool calls
...
Use it when the security objective matches **Runtime monitoring and intervention for AI-agent actions and tool calls** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Adrian Agent Security** and read this guide before execution.
...
```bash
Adrian Agent Security --help
Adrian Agent Security --version
```
...
**One sentence:** Adrian Agent Security is used to help the team achieve **Runtime monitoring and intervention for AI-agent actions and tool calls** under an approved and auditable VEYRA workflow.
