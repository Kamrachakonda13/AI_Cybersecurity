...
## What is it?
Kali security utility: mssqlpwner
...
Use it when the security objective matches **Kali security utility: mssqlpwner** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **mssqlpwner** and read this guide before execution.
...
**One sentence:** mssqlpwner is used to help the team achieve **Kali security utility: mssqlpwner** under an approved and auditable VEYRA workflow.
