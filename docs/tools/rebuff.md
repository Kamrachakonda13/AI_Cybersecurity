...
2. Search for **rebuff** and read this guide before execution.
...
**One sentence:** rebuff is used to help the team achieve **Prompt-injection detection integration candidate** under an approved and auditable VEYRA workflow.
