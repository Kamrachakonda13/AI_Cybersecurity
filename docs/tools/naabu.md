...
Use it when the security objective matches **Port discovery** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** Naabu is used to help the team achieve **Port discovery** under an approved and auditable VEYRA workflow.
