...
**Purpose:** Artifact provenance and supply-chain attestations  
**VEYRA access:** admin  
**Execution boundary:** approved_worker

## What is it?
Artifact provenance and supply-chain attestations
...
Use it when the security objective matches **Artifact provenance and supply-chain attestations** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **in-toto** and read this guide before execution.
...
**One sentence:** in-toto is used to help the team achieve **Artifact provenance and supply-chain attestations** under an approved and auditable VEYRA workflow.
