...
## What is it?
Kali security utility: whatmask
...
Use it when the security objective matches **Kali security utility: whatmask** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **whatmask** and read this guide before execution.
...
**One sentence:** whatmask is used to help the team achieve **Kali security utility: whatmask** under an approved and auditable VEYRA workflow.
