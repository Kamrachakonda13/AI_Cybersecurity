...
Use it when the security objective matches **Kali security utility: gef** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **gef** and read this guide before execution.
