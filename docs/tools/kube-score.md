...
## What is it?
Advanced kubernetes capability: kube-score
...
Use it when the security objective matches **Advanced kubernetes capability: kube-score** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **kube-score** and read this guide before execution.
...
**One sentence:** kube-score is used to help the team achieve **Advanced kubernetes capability: kube-score** under an approved and auditable VEYRA workflow.
