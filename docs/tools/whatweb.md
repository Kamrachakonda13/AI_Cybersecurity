...
Use it when the security objective matches **Technology fingerprinting** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **WhatWeb** and read this guide before execution.
...
**One sentence:** WhatWeb is used to help the team achieve **Technology fingerprinting** under an approved and auditable VEYRA workflow.
