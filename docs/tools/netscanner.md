...
## What is it?
Kali security utility: netscanner
...
Use it when the security objective matches **Kali security utility: netscanner** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **netscanner** and read this guide before execution.
...
**One sentence:** netscanner is used to help the team achieve **Kali security utility: netscanner** under an approved and auditable VEYRA workflow.
