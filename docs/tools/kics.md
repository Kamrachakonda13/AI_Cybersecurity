...
## What is it?
Advanced cloud capability: KICS
...
Use it when the security objective matches **Advanced cloud capability: KICS** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **KICS** and read this guide before execution.
...
**One sentence:** KICS is used to help the team achieve **Advanced cloud capability: KICS** under an approved and auditable VEYRA workflow.
