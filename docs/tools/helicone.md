...
**Purpose:** LLM gateway observability connector  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
LLM gateway observability connector
...
Use it when the security objective matches **LLM gateway observability connector** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **helicone** and read this guide before execution.
...
**One sentence:** helicone is used to help the team achieve **LLM gateway observability connector** under an approved and auditable VEYRA workflow.
