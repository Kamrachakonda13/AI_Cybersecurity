...
## What is it?
Advanced cloud capability: Parliament
...
Use it when the security objective matches **Advanced cloud capability: Parliament** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Parliament** and read this guide before execution.
...
**One sentence:** Parliament is used to help the team achieve **Advanced cloud capability: Parliament** under an approved and auditable VEYRA workflow.
