...
**Purpose:** RAG and agent pipeline evaluation integration  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
RAG and agent pipeline evaluation integration
...
Use it when the security objective matches **RAG and agent pipeline evaluation integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Haystack** and read this guide before execution.
...
**One sentence:** Haystack is used to help the team achieve **RAG and agent pipeline evaluation integration** under an approved and auditable VEYRA workflow.
