...
## What is it?
Advanced cloud capability: Cloud Custodian
...
Use it when the security objective matches **Advanced cloud capability: Cloud Custodian** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Cloud Custodian** and read this guide before execution.
...
**One sentence:** Cloud Custodian is used to help the team achieve **Advanced cloud capability: Cloud Custodian** under an approved and auditable VEYRA workflow.
