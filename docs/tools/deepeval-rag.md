...
**Purpose:** RAG metrics/evaluation integration  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
RAG metrics/evaluation integration
...
Use it when the security objective matches **RAG metrics/evaluation integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **deepeval-rag** and read this guide before execution.
...
**One sentence:** deepeval-rag is used to help the team achieve **RAG metrics/evaluation integration** under an approved and auditable VEYRA workflow.
