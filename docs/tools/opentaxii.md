...
## What is it?
Kali security utility: opentaxii
...
Use it when the security objective matches **Kali security utility: opentaxii** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **opentaxii** and read this guide before execution.
...
**One sentence:** opentaxii is used to help the team achieve **Kali security utility: opentaxii** under an approved and auditable VEYRA workflow.
