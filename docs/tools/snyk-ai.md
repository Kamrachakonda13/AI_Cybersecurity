...
**Category:** AI AppSec  
**Purpose:** AI/application dependency security connector  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
AI/application dependency security connector
...
Use it when the security objective matches **AI/application dependency security connector** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **snyk-ai** and read this guide before execution.
...
**One sentence:** snyk-ai is used to help the team achieve **AI/application dependency security connector** under an approved and auditable VEYRA workflow.
