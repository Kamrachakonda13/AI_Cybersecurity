...
**Category:** AI SBOM  
**Purpose:** AI bill-of-materials generation integration  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
AI bill-of-materials generation integration
...
Use it when the security objective matches **AI bill-of-materials generation integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **aibom-generator** and read this guide before execution.
...
```bash
aibom-generator --help
aibom-generator --version
```
...
**One sentence:** aibom-generator is used to help the team achieve **AI bill-of-materials generation integration** under an approved and auditable VEYRA workflow.
