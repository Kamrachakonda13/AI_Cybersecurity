...
2. Search for **Snort** and read this guide before execution.
...
**One sentence:** Snort is used to help the team achieve **IDS/NSM** under an approved and auditable VEYRA workflow.
