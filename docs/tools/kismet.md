...
## What is it?
Advanced wireless capability: Kismet
...
Use it when the security objective matches **Advanced wireless capability: Kismet** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Kismet** and read this guide before execution.
...
**One sentence:** Kismet is used to help the team achieve **Advanced wireless capability: Kismet** under an approved and auditable VEYRA workflow.
