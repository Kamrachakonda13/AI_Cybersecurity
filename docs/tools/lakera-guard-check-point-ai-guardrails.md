...
## What is it?
Prompt injection, jailbreak and data-leakage runtime defense
...
Use it when the security objective matches **Prompt injection, jailbreak and data-leakage runtime defense** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Lakera Guard / Check Point AI Guardrails** and read this guide before execution.
...
## Safe workflow
Assess an approved AI application or agent for prompt/context integrity, tool authorization, RAG/data access, model supply chain and runtime telemetry.
...
**One sentence:** Lakera Guard / Check Point AI Guardrails is used to help the team achieve **Prompt injection, jailbreak and data-leakage runtime defense** under an approved and auditable VEYRA workflow.
