...
**Purpose:** Adversarial NLP robustness testing  
**VEYRA access:** admin  
**Execution boundary:** isolated_analysis_worker

## What is it?
Adversarial NLP robustness testing
...
Use it when the security objective matches **Adversarial NLP robustness testing** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **TextAttack** and read this guide before execution.
...
**One sentence:** TextAttack is used to help the team achieve **Adversarial NLP robustness testing** under an approved and auditable VEYRA workflow.
