...
## What is it?
Kali security utility: routersploit
...
Use it when the security objective matches **Kali security utility: routersploit** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **routersploit** and read this guide before execution.
...
**One sentence:** routersploit is used to help the team achieve **Kali security utility: routersploit** under an approved and auditable VEYRA workflow.
