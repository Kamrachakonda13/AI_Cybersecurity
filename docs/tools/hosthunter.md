...
## What is it?
Kali security utility: hosthunter
...
Use it when the security objective matches **Kali security utility: hosthunter** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **hosthunter** and read this guide before execution.
...
**One sentence:** hosthunter is used to help the team achieve **Kali security utility: hosthunter** under an approved and auditable VEYRA workflow.
