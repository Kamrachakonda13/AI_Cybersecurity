...
## What is it?
Advanced dfir capability: YARA-X
...
Use it when the security objective matches **Advanced dfir capability: YARA-X** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **YARA-X** and read this guide before execution.
...
**One sentence:** YARA-X is used to help the team achieve **Advanced dfir capability: YARA-X** under an approved and auditable VEYRA workflow.
