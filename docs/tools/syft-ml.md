...
**Category:** AI SBOM  
**Purpose:** AI/ML artifact SBOM integration  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
AI/ML artifact SBOM integration
...
Use it when the security objective matches **AI/ML artifact SBOM integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **syft-ml** and read this guide before execution.
...
**One sentence:** syft-ml is used to help the team achieve **AI/ML artifact SBOM integration** under an approved and auditable VEYRA workflow.
