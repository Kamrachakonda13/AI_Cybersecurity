...
## What is it?
Advanced identity capability: BloodyAD
...
Use it when the security objective matches **Advanced identity capability: BloodyAD** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **BloodyAD** and read this guide before execution.
...
**One sentence:** BloodyAD is used to help the team achieve **Advanced identity capability: BloodyAD** under an approved and auditable VEYRA workflow.
