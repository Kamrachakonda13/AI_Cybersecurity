...
**Purpose:** AI security/governance connector  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
AI security/governance connector
...
Use it when the security objective matches **AI security/governance connector** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **calypsoai** and read this guide before execution.
...
**One sentence:** calypsoai is used to help the team achieve **AI security/governance connector** under an approved and auditable VEYRA workflow.
