...
## What is it?
Advanced dfir capability: Timesketch
...
Use it when the security objective matches **Advanced dfir capability: Timesketch** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Timesketch** and read this guide before execution.
...
**One sentence:** Timesketch is used to help the team achieve **Advanced dfir capability: Timesketch** under an approved and auditable VEYRA workflow.
