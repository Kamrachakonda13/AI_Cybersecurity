...
## What is it?
Kali security utility: evilginx2
...
Use it when the security objective matches **Kali security utility: evilginx2** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **evilginx2** and read this guide before execution.
...
**One sentence:** evilginx2 is used to help the team achieve **Kali security utility: evilginx2** under an approved and auditable VEYRA workflow.
