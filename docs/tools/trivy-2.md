...
Use it when the security objective matches **Kali security utility: trivy** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** trivy is used to help the team achieve **Kali security utility: trivy** under an approved and auditable VEYRA workflow.
