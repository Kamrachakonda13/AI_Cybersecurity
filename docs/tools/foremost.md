...
Use it when the security objective matches **File carving** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **foremost** and read this guide before execution.
...
**One sentence:** foremost is used to help the team achieve **File carving** under an approved and auditable VEYRA workflow.
