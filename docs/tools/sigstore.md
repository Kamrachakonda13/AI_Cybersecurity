...
**Purpose:** Keyless artifact signing and verification  
**VEYRA access:** admin  
...
Use it when the security objective matches **Keyless artifact signing and verification** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **sigstore** and read this guide before execution.
...
**One sentence:** sigstore is used to help the team achieve **Keyless artifact signing and verification** under an approved and auditable VEYRA workflow.
