...
Use it when the security objective matches **Web vulnerability assessment** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Wapiti** and read this guide before execution.
...
**One sentence:** Wapiti is used to help the team achieve **Web vulnerability assessment** under an approved and auditable VEYRA workflow.
