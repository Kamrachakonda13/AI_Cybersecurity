...
**Purpose:** Dataset/data-card governance integration  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Dataset/data-card governance integration
...
Use it when the security objective matches **Dataset/data-card governance integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **datasheets** and read this guide before execution.
...
**One sentence:** datasheets is used to help the team achieve **Dataset/data-card governance integration** under an approved and auditable VEYRA workflow.
