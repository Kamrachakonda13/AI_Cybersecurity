...
## What is it?
Advanced ai security capability: PyRIT
...
Use it when the security objective matches **Advanced ai security capability: PyRIT** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **PyRIT** and read this guide before execution.
...
**One sentence:** PyRIT is used to help the team achieve **Advanced ai security capability: PyRIT** under an approved and auditable VEYRA workflow.
