...
**Purpose:** Governed AI security assessment orchestration  
**VEYRA access:** privileged_admin  
**Execution boundary:** isolated_ai_worker

## What is it?
Governed AI security assessment orchestration
...
Use it when the security objective matches **Governed AI security assessment orchestration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ai-red-team-orchestrator** and read this guide before execution.
...
```bash
ai-red-team-orchestrator --help
ai-red-team-orchestrator --version
```
...
**One sentence:** ai-red-team-orchestrator is used to help the team achieve **Governed AI security assessment orchestration** under an approved and auditable VEYRA workflow.
