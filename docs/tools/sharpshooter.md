...
## What is it?
Kali security utility: sharpshooter
...
Use it when the security objective matches **Kali security utility: sharpshooter** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **sharpshooter** and read this guide before execution.
...
**One sentence:** sharpshooter is used to help the team achieve **Kali security utility: sharpshooter** under an approved and auditable VEYRA workflow.
