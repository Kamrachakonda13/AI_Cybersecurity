...
Use it when the security objective matches **Capability identification** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **capa** and read this guide before execution.
...
**One sentence:** capa is used to help the team achieve **Capability identification** under an approved and auditable VEYRA workflow.
