...
## What is it?
Kali security utility: httpx-toolkit
...
Use it when the security objective matches **Kali security utility: httpx-toolkit** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **httpx-toolkit** and read this guide before execution.
...
**One sentence:** httpx-toolkit is used to help the team achieve **Kali security utility: httpx-toolkit** under an approved and auditable VEYRA workflow.
