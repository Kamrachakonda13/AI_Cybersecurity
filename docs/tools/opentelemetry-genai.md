...
## What is it?
Advanced ai security capability: OpenTelemetry GenAI
...
Use it when the security objective matches **Advanced ai security capability: OpenTelemetry GenAI** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **OpenTelemetry GenAI** and read this guide before execution.
...
```bash
opentelemetry-genai --help
opentelemetry-genai --version
```
...
**One sentence:** OpenTelemetry GenAI is used to help the team achieve **Advanced ai security capability: OpenTelemetry GenAI** under an approved and auditable VEYRA workflow.
