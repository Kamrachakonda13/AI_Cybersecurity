...
## What is it?
Advanced identity capability: Purple Knight
...
Use it when the security objective matches **Advanced identity capability: Purple Knight** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Purple Knight** and read this guide before execution.
...
**One sentence:** Purple Knight is used to help the team achieve **Advanced identity capability: Purple Knight** under an approved and auditable VEYRA workflow.
