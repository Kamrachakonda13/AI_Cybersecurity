...
## What is it?
Kali security utility: arsenal-ng
...
Use it when the security objective matches **Kali security utility: arsenal-ng** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **arsenal-ng** and read this guide before execution.
...
**One sentence:** arsenal-ng is used to help the team achieve **Kali security utility: arsenal-ng** under an approved and auditable VEYRA workflow.
