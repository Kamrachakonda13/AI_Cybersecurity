...
## What is it?
Kali security utility: bruteforce-luks
...
Use it when the security objective matches **Kali security utility: bruteforce-luks** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **bruteforce-luks** and read this guide before execution.
...
**One sentence:** bruteforce-luks is used to help the team achieve **Kali security utility: bruteforce-luks** under an approved and auditable VEYRA workflow.
