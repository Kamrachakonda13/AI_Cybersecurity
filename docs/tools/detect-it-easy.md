...
## What is it?
Kali security utility: detect-it-easy
...
Use it when the security objective matches **Kali security utility: detect-it-easy** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **detect-it-easy** and read this guide before execution.
...
## Safe workflow
Open a copy in an isolated workspace, inspect metadata/imports/strings/control flow, map behavior to detections, and preserve hashes.
...
**One sentence:** detect-it-easy is used to help the team achieve **Kali security utility: detect-it-easy** under an approved and auditable VEYRA workflow.
