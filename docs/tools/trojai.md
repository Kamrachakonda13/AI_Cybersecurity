...
## What is it?
Model vulnerability and adversarial stress-testing integration
...
Use it when the security objective matches **Model vulnerability and adversarial stress-testing integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **TrojAI** and read this guide before execution.
...
**One sentence:** TrojAI is used to help the team achieve **Model vulnerability and adversarial stress-testing integration** under an approved and auditable VEYRA workflow.
