...
2. Search for **OWASP ZAP** and read this guide before execution.
...
**One sentence:** OWASP ZAP is used to help the team achieve **Web application security assessment** under an approved and auditable VEYRA workflow.
