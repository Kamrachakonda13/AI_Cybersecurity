...
## What is it?
Advanced ai security capability: OpenAI Evals
...
Use it when the security objective matches **Advanced ai security capability: OpenAI Evals** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **OpenAI Evals** and read this guide before execution.
...
**One sentence:** OpenAI Evals is used to help the team achieve **Advanced ai security capability: OpenAI Evals** under an approved and auditable VEYRA workflow.
