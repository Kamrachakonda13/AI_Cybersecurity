...
Use it when the security objective matches **Web server posture assessment** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Nikto** and read this guide before execution.
...
**One sentence:** Nikto is used to help the team achieve **Web server posture assessment** under an approved and auditable VEYRA workflow.
