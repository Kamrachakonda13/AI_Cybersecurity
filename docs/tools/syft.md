...
Use it when the security objective matches **SBOM generation** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** Syft is used to help the team achieve **SBOM generation** under an approved and auditable VEYRA workflow.
