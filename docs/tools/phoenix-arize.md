...
## What is it?
Advanced ai security capability: Phoenix Arize
...
Use it when the security objective matches **Advanced ai security capability: Phoenix Arize** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Phoenix Arize** and read this guide before execution.
...
**One sentence:** Phoenix Arize is used to help the team achieve **Advanced ai security capability: Phoenix Arize** under an approved and auditable VEYRA workflow.
