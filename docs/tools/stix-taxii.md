...
Use it when the security objective matches **Threat-intel transport** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **STIX/TAXII** and read this guide before execution.
...
**One sentence:** STIX/TAXII is used to help the team achieve **Threat-intel transport** under an approved and auditable VEYRA workflow.
