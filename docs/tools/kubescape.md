...
Use it when the security objective matches **Kubernetes posture/security** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Kubescape** and read this guide before execution.
...
**One sentence:** Kubescape is used to help the team achieve **Kubernetes posture/security** under an approved and auditable VEYRA workflow.
