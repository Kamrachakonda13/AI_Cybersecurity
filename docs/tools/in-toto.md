...
**Purpose:** Software/AI supply-chain attestations  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Software/AI supply-chain attestations
...
Use it when the security objective matches **Software/AI supply-chain attestations** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** in-toto is used to help the team achieve **Software/AI supply-chain attestations** under an approved and auditable VEYRA workflow.
