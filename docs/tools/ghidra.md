...
2. Search for **Ghidra** and read this guide before execution.
...
**One sentence:** Ghidra is used to help the team achieve **Static reverse engineering** under an approved and auditable VEYRA workflow.
