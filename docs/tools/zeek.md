...
Use it when the security objective matches **Network security monitoring** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Zeek** and read this guide before execution.
...
## Safe workflow
Inspect telemetry from networks you manage, identify anomalous protocols/flows, and turn validated observations into detections.
...
**One sentence:** Zeek is used to help the team achieve **Network security monitoring** under an approved and auditable VEYRA workflow.
