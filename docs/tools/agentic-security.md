...
**Purpose:** Agent identity, tool authorization and runtime policy checks  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Agent identity, tool authorization and runtime policy checks
...
Use it when the security objective matches **Agent identity, tool authorization and runtime policy checks** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **agentic-security** and read this guide before execution.
...
**One sentence:** agentic-security is used to help the team achieve **Agent identity, tool authorization and runtime policy checks** under an approved and auditable VEYRA workflow.
