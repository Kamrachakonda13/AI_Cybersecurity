...
Use it when the security objective matches **High-speed exposure inventory** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Masscan** and read this guide before execution.
...
**One sentence:** Masscan is used to help the team achieve **High-speed exposure inventory** under an approved and auditable VEYRA workflow.
