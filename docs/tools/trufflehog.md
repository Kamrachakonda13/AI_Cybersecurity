...
## What is it?
Kali security utility: trufflehog
...
Use it when the security objective matches **Kali security utility: trufflehog** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** trufflehog is used to help the team achieve **Kali security utility: trufflehog** under an approved and auditable VEYRA workflow.
