...
**Category:** AI AppSec  
**Purpose:** CodeQL security analysis integration  
**VEYRA access:** admin  
...
Use it when the security objective matches **CodeQL security analysis integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **codeql-ai** and read this guide before execution.
...
**One sentence:** codeql-ai is used to help the team achieve **CodeQL security analysis integration** under an approved and auditable VEYRA workflow.
