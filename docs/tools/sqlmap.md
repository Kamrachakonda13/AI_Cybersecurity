...
## What is it?
Authorized SQL injection assessment
...
Use it when the security objective matches **Authorized SQL injection assessment** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **SQLMap** and read this guide before execution.
...
**One sentence:** SQLMap is used to help the team achieve **Authorized SQL injection assessment** under an approved and auditable VEYRA workflow.
