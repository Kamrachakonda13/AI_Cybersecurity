...
## What is it?
Kali security utility: krbrelayx
...
Use it when the security objective matches **Kali security utility: krbrelayx** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **krbrelayx** and read this guide before execution.
...
**One sentence:** krbrelayx is used to help the team achieve **Kali security utility: krbrelayx** under an approved and auditable VEYRA workflow.
