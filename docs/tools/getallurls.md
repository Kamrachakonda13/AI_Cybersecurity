...
## What is it?
Kali security utility: getallurls
...
Use it when the security objective matches **Kali security utility: getallurls** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **getallurls** and read this guide before execution.
...
**One sentence:** getallurls is used to help the team achieve **Kali security utility: getallurls** under an approved and auditable VEYRA workflow.
