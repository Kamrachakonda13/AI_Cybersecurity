...
## What is it?
Kali security utility: tetragon
...
Use it when the security objective matches **Kali security utility: tetragon** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** tetragon is used to help the team achieve **Kali security utility: tetragon** under an approved and auditable VEYRA workflow.
