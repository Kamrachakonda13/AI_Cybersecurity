...
**Category:** AI SOC  
**Purpose:** AI-assisted SOC investigation integration  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
AI-assisted SOC investigation integration
...
Use it when the security objective matches **AI-assisted SOC investigation integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ai-soc-copilot** and read this guide before execution.
