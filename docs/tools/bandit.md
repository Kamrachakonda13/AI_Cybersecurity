...
Use it when the security objective matches **Python security analysis** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Bandit** and read this guide before execution.
...
**One sentence:** Bandit is used to help the team achieve **Python security analysis** under an approved and auditable VEYRA workflow.
