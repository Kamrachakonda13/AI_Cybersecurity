...
## What is it?
Kali security utility: freeradius
...
Use it when the security objective matches **Kali security utility: freeradius** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **freeradius** and read this guide before execution.
...
**One sentence:** freeradius is used to help the team achieve **Kali security utility: freeradius** under an approved and auditable VEYRA workflow.
