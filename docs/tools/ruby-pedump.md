...
## What is it?
Kali security utility: ruby-pedump
...
Use it when the security objective matches **Kali security utility: ruby-pedump** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ruby-pedump** and read this guide before execution.
...
**One sentence:** ruby-pedump is used to help the team achieve **Kali security utility: ruby-pedump** under an approved and auditable VEYRA workflow.
