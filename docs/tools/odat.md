...
Use it when the security objective matches **Kali security utility: odat** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **odat** and read this guide before execution.
...
**One sentence:** odat is used to help the team achieve **Kali security utility: odat** under an approved and auditable VEYRA workflow.
