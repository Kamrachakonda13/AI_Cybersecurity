...
Use it when the security objective matches **IOC exchange** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **MISP** and read this guide before execution.
...
**One sentence:** MISP is used to help the team achieve **IOC exchange** under an approved and auditable VEYRA workflow.
