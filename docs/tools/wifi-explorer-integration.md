...
## What is it?
Advanced wireless capability: WiFi Explorer integration
...
Use it when the security objective matches **Advanced wireless capability: WiFi Explorer integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **WiFi Explorer integration** and read this guide before execution.
...
```bash
WiFi Explorer integration --help
WiFi Explorer integration --version
```
...
**One sentence:** WiFi Explorer integration is used to help the team achieve **Advanced wireless capability: WiFi Explorer integration** under an approved and auditable VEYRA workflow.
