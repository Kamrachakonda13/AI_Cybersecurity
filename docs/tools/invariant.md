...
## What is it?
Advanced ai security capability: Invariant
...
Use it when the security objective matches **Advanced ai security capability: Invariant** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Invariant** and read this guide before execution.
...
**One sentence:** Invariant is used to help the team achieve **Advanced ai security capability: Invariant** under an approved and auditable VEYRA workflow.
