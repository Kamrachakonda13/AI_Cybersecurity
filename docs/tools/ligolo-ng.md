...
## What is it?
Kali security utility: ligolo-ng
...
Use it when the security objective matches **Kali security utility: ligolo-ng** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ligolo-ng** and read this guide before execution.
...
**One sentence:** ligolo-ng is used to help the team achieve **Kali security utility: ligolo-ng** under an approved and auditable VEYRA workflow.
