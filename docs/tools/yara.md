...
Use it when the security objective matches **Static malware classification** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **YARA** and read this guide before execution.
...
## Safe workflow
Analyze samples in isolated analysis workers, begin with static indicators/capabilities, and preserve hashes and evidence.
...
**One sentence:** YARA is used to help the team achieve **Static malware classification** under an approved and auditable VEYRA workflow.
