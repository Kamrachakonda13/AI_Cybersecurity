...
Use it when the security objective matches **Kali security utility: maryam** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **maryam** and read this guide before execution.
...
**One sentence:** maryam is used to help the team achieve **Kali security utility: maryam** under an approved and auditable VEYRA workflow.
