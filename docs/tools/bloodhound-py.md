...
## What is it?
Kali security utility: bloodhound.py
...
Use it when the security objective matches **Kali security utility: bloodhound.py** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **bloodhound.py** and read this guide before execution.
...
**One sentence:** bloodhound.py is used to help the team achieve **Kali security utility: bloodhound.py** under an approved and auditable VEYRA workflow.
