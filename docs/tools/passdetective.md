...
## What is it?
Kali security utility: passdetective
...
Use it when the security objective matches **Kali security utility: passdetective** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **passdetective** and read this guide before execution.
...
**One sentence:** passdetective is used to help the team achieve **Kali security utility: passdetective** under an approved and auditable VEYRA workflow.
