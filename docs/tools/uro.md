...
Use it when the security objective matches **Kali security utility: uro** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **uro** and read this guide before execution.
...
**One sentence:** uro is used to help the team achieve **Kali security utility: uro** under an approved and auditable VEYRA workflow.
