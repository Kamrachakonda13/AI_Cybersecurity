...
2. Search for **Hydra** and read this guide before execution.
...
**One sentence:** Hydra is used to help the team achieve **Authorized authentication testing** under an approved and auditable VEYRA workflow.
