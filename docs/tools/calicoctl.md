...
## What is it?
Kali security utility: calicoctl
...
Use it when the security objective matches **Kali security utility: calicoctl** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **calicoctl** and read this guide before execution.
...
**One sentence:** calicoctl is used to help the team achieve **Kali security utility: calicoctl** under an approved and auditable VEYRA workflow.
