...
## What is it?
ML adversarial robustness testing
...
Use it when the security objective matches **ML adversarial robustness testing** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Adversarial Robustness Toolbox** and read this guide before execution.
...
**One sentence:** Adversarial Robustness Toolbox is used to help the team achieve **ML adversarial robustness testing** under an approved and auditable VEYRA workflow.
