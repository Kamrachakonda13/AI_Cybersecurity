...
## What is it?
Kali security utility: linkedin2username
...
Use it when the security objective matches **Kali security utility: linkedin2username** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **linkedin2username** and read this guide before execution.
...
**One sentence:** linkedin2username is used to help the team achieve **Kali security utility: linkedin2username** under an approved and auditable VEYRA workflow.
