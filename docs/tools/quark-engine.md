...
## What is it?
Kali security utility: quark-engine
...
Use it when the security objective matches **Kali security utility: quark-engine** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **quark-engine** and read this guide before execution.
...
**One sentence:** quark-engine is used to help the team achieve **Kali security utility: quark-engine** under an approved and auditable VEYRA workflow.
