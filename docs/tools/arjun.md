...
Use it when the security objective matches **Kali security utility: arjun** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** arjun is used to help the team achieve **Kali security utility: arjun** under an approved and auditable VEYRA workflow.
