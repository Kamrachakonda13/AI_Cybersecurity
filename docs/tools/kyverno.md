...
**Purpose:** Kubernetes-native policy, validation, mutation and image verification  
**VEYRA access:** admin  
...
Use it when the security objective matches **Kubernetes-native policy, validation, mutation and image verification** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Kyverno** and read this guide before execution.
...
**One sentence:** Kyverno is used to help the team achieve **Kubernetes-native policy, validation, mutation and image verification** under an approved and auditable VEYRA workflow.
