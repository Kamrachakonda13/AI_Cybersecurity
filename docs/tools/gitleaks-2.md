...
## What is it?
Advanced appsec capability: Gitleaks
...
Use it when the security objective matches **Advanced appsec capability: Gitleaks** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** Gitleaks is used to help the team achieve **Advanced appsec capability: Gitleaks** under an approved and auditable VEYRA workflow.
