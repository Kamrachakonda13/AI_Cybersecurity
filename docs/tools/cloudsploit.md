...
Use it when the security objective matches **Cloud configuration assessment** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **CloudSploit** and read this guide before execution.
...
**One sentence:** CloudSploit is used to help the team achieve **Cloud configuration assessment** under an approved and auditable VEYRA workflow.
