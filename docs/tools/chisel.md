...
Use it when the security objective matches **Kali security utility: chisel** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **chisel** and read this guide before execution.
...
**One sentence:** chisel is used to help the team achieve **Kali security utility: chisel** under an approved and auditable VEYRA workflow.
