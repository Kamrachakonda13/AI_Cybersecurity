...
## What is it?
Kali security utility: mongo-tools
...
Use it when the security objective matches **Kali security utility: mongo-tools** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **mongo-tools** and read this guide before execution.
...
**One sentence:** mongo-tools is used to help the team achieve **Kali security utility: mongo-tools** under an approved and auditable VEYRA workflow.
