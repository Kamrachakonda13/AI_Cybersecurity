...
Use it when the security objective matches **AD CS security assessment** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Certipy** and read this guide before execution.
...
**One sentence:** Certipy is used to help the team achieve **AD CS security assessment** under an approved and auditable VEYRA workflow.
