...
Use it when the security objective matches **Kali security utility: h8mail** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **h8mail** and read this guide before execution.
...
**One sentence:** h8mail is used to help the team achieve **Kali security utility: h8mail** under an approved and auditable VEYRA workflow.
