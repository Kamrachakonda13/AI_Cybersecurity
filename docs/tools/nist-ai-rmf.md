...
**Purpose:** AI risk-management control mapping  
**VEYRA access:** admin  
**Execution boundary:** approved_connector

## What is it?
AI risk-management control mapping
...
Use it when the security objective matches **AI risk-management control mapping** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **NIST AI RMF** and read this guide before execution.
...
**One sentence:** NIST AI RMF is used to help the team achieve **AI risk-management control mapping** under an approved and auditable VEYRA workflow.
