...
**Purpose:** Dependency vulnerability scanning for AI applications  
**VEYRA access:** admin  
**Execution boundary:** approved_worker

## What is it?
Dependency vulnerability scanning for AI applications
...
Use it when the security objective matches **Dependency vulnerability scanning for AI applications** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **OSV-Scanner** and read this guide before execution.
...
**One sentence:** OSV-Scanner is used to help the team achieve **Dependency vulnerability scanning for AI applications** under an approved and auditable VEYRA workflow.
