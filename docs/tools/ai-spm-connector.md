...
## What is it?
Advanced ai security capability: AI-SPM Connector
...
Use it when the security objective matches **Advanced ai security capability: AI-SPM Connector** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **AI-SPM Connector** and read this guide before execution.
...
```bash
ai-spm-connector --help
ai-spm-connector --version
```
...
**One sentence:** AI-SPM Connector is used to help the team achieve **Advanced ai security capability: AI-SPM Connector** under an approved and auditable VEYRA workflow.
