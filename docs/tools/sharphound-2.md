...
## What is it?
Advanced identity capability: SharpHound
...
Use it when the security objective matches **Advanced identity capability: SharpHound** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **SharpHound** and read this guide before execution.
...
**One sentence:** SharpHound is used to help the team achieve **Advanced identity capability: SharpHound** under an approved and auditable VEYRA workflow.
