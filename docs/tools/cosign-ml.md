...
**Purpose:** Signed AI artifact provenance integration  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Signed AI artifact provenance integration
...
Use it when the security objective matches **Signed AI artifact provenance integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **cosign-ml** and read this guide before execution.
...
**One sentence:** cosign-ml is used to help the team achieve **Signed AI artifact provenance integration** under an approved and auditable VEYRA workflow.
