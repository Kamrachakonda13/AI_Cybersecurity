...
**Category:** AI Gateway  
**Purpose:** Content safety classification and policy enforcement  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Content safety classification and policy enforcement
...
Use it when the security objective matches **Content safety classification and policy enforcement** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Llama Guard** and read this guide before execution.
...
**One sentence:** Llama Guard is used to help the team achieve **Content safety classification and policy enforcement** under an approved and auditable VEYRA workflow.
