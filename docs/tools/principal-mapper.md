...
## What is it?
Advanced cloud capability: Principal Mapper
...
Use it when the security objective matches **Advanced cloud capability: Principal Mapper** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Principal Mapper** and read this guide before execution.
...
```bash
principal-mapper --help
principal-mapper --version
```
...
**One sentence:** Principal Mapper is used to help the team achieve **Advanced cloud capability: Principal Mapper** under an approved and auditable VEYRA workflow.
