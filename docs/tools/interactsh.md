...
## What is it?
Advanced security utilities capability: Interactsh
...
Use it when the security objective matches **Advanced security utilities capability: Interactsh** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Interactsh** and read this guide before execution.
...
**One sentence:** Interactsh is used to help the team achieve **Advanced security utilities capability: Interactsh** under an approved and auditable VEYRA workflow.
