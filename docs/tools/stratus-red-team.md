...
## What is it?
Advanced cloud capability: Stratus Red Team
...
Use it when the security objective matches **Advanced cloud capability: Stratus Red Team** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Stratus Red Team** and read this guide before execution.
...
```bash
stratus-red-team --help
stratus-red-team --version
```
...
**One sentence:** Stratus Red Team is used to help the team achieve **Advanced cloud capability: Stratus Red Team** under an approved and auditable VEYRA workflow.
