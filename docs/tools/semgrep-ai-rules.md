...
## What is it?
Advanced ai security capability: Semgrep AI rules
...
Use it when the security objective matches **Advanced ai security capability: Semgrep AI rules** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Semgrep AI rules** and read this guide before execution.
...
**One sentence:** Semgrep AI rules is used to help the team achieve **Advanced ai security capability: Semgrep AI rules** under an approved and auditable VEYRA workflow.
