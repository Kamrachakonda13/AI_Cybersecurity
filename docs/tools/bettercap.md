...
## What is it?
Advanced wireless capability: Bettercap
...
Use it when the security objective matches **Advanced wireless capability: Bettercap** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Bettercap** and read this guide before execution.
...
**One sentence:** Bettercap is used to help the team achieve **Advanced wireless capability: Bettercap** under an approved and auditable VEYRA workflow.
