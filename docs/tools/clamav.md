...
Use it when the security objective matches **Malware scanning** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ClamAV** and read this guide before execution.
...
**One sentence:** ClamAV is used to help the team achieve **Malware scanning** under an approved and auditable VEYRA workflow.
