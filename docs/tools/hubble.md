...
Use it when the security objective matches **Kali security utility: hubble** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** hubble is used to help the team achieve **Kali security utility: hubble** under an approved and auditable VEYRA workflow.
