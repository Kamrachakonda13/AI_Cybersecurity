...
## What is it?
Kali security utility: python3-pyinstaller
...
Use it when the security objective matches **Kali security utility: python3-pyinstaller** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **python3-pyinstaller** and read this guide before execution.
...
**One sentence:** python3-pyinstaller is used to help the team achieve **Kali security utility: python3-pyinstaller** under an approved and auditable VEYRA workflow.
