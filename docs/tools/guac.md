...
**Purpose:** Graph-based aggregation and querying of software supply-chain evidence  
**VEYRA access:** admin  
**Execution boundary:** approved_worker

## What is it?
Graph-based aggregation and querying of software supply-chain evidence
...
Use it when the security objective matches **Graph-based aggregation and querying of software supply-chain evidence** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **GUAC** and read this guide before execution.
...
**One sentence:** GUAC is used to help the team achieve **Graph-based aggregation and querying of software supply-chain evidence** under an approved and auditable VEYRA workflow.
