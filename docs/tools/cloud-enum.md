...
## What is it?
Kali security utility: cloud-enum
...
Use it when the security objective matches **Kali security utility: cloud-enum** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **cloud-enum** and read this guide before execution.
...
**One sentence:** cloud-enum is used to help the team achieve **Kali security utility: cloud-enum** under an approved and auditable VEYRA workflow.
