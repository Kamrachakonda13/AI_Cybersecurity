...
Use it when the security objective matches **Disk forensics** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Autopsy** and read this guide before execution.
...
**One sentence:** Autopsy is used to help the team achieve **Disk forensics** under an approved and auditable VEYRA workflow.
