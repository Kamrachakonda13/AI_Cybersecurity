...
## What is it?
Kali security utility: wifiphisher
...
Use it when the security objective matches **Kali security utility: wifiphisher** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **wifiphisher** and read this guide before execution.
...
**One sentence:** wifiphisher is used to help the team achieve **Kali security utility: wifiphisher** under an approved and auditable VEYRA workflow.
