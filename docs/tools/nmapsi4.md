...
Use it when the security objective matches **Kali security utility: nmapsi4** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **nmapsi4** and read this guide before execution.
...
**One sentence:** nmapsi4 is used to help the team achieve **Kali security utility: nmapsi4** under an approved and auditable VEYRA workflow.
