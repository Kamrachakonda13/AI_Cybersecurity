...
**Category:** AI Gateway  
**Purpose:** AI gateway observability, guardrails and routing integration  
**VEYRA access:** admin  
**Execution boundary:** approved_connector

## What is it?
AI gateway observability, guardrails and routing integration
...
Use it when the security objective matches **AI gateway observability, guardrails and routing integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Portkey** and read this guide before execution.
...
**One sentence:** Portkey is used to help the team achieve **AI gateway observability, guardrails and routing integration** under an approved and auditable VEYRA workflow.
