...
**Purpose:** MCP runtime governance integration candidate  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
MCP runtime governance integration candidate
...
Use it when the security objective matches **MCP runtime governance integration candidate** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **mcp-guardian** and read this guide before execution.
...
**One sentence:** mcp-guardian is used to help the team achieve **MCP runtime governance integration candidate** under an approved and auditable VEYRA workflow.
