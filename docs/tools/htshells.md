...
## What is it?
Kali security utility: htshells
...
Use it when the security objective matches **Kali security utility: htshells** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **htshells** and read this guide before execution.
...
**One sentence:** htshells is used to help the team achieve **Kali security utility: htshells** under an approved and auditable VEYRA workflow.
