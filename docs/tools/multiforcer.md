...
## What is it?
Kali security utility: multiforcer
...
Use it when the security objective matches **Kali security utility: multiforcer** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **multiforcer** and read this guide before execution.
...
**One sentence:** multiforcer is used to help the team achieve **Kali security utility: multiforcer** under an approved and auditable VEYRA workflow.
