...
**Category:** AI Gateway  
**Purpose:** Input/output scanners for LLM applications  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Input/output scanners for LLM applications
...
Use it when the security objective matches **Input/output scanners for LLM applications** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **llm-guard** and read this guide before execution.
...
**One sentence:** llm-guard is used to help the team achieve **Input/output scanners for LLM applications** under an approved and auditable VEYRA workflow.
