...
## What is it?
Advanced dfir capability: Plaso
...
Use it when the security objective matches **Advanced dfir capability: Plaso** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Plaso** and read this guide before execution.
...
**One sentence:** Plaso is used to help the team achieve **Advanced dfir capability: Plaso** under an approved and auditable VEYRA workflow.
