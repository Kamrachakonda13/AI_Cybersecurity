...
**Purpose:** Automated open-source project security health assessment  
**VEYRA access:** admin  
**Execution boundary:** approved_worker

## What is it?
Automated open-source project security health assessment
...
Use it when the security objective matches **Automated open-source project security health assessment** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **OpenSSF Scorecard** and read this guide before execution.
...
```bash
OpenSSF Scorecard --help
OpenSSF Scorecard --version
```
...
**One sentence:** OpenSSF Scorecard is used to help the team achieve **Automated open-source project security health assessment** under an approved and auditable VEYRA workflow.
