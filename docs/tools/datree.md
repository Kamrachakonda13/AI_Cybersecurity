...
## What is it?
Advanced security utilities capability: Datree
...
Use it when the security objective matches **Advanced security utilities capability: Datree** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Datree** and read this guide before execution.
...
**One sentence:** Datree is used to help the team achieve **Advanced security utilities capability: Datree** under an approved and auditable VEYRA workflow.
