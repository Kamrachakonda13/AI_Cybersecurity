...
**Purpose:** Prompt/context provenance and integrity tracking  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Prompt/context provenance and integrity tracking
...
Use it when the security objective matches **Prompt/context provenance and integrity tracking** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **prompt-provenance** and read this guide before execution.
...
```bash
prompt-provenance --help
prompt-provenance --version
```
...
**One sentence:** prompt-provenance is used to help the team achieve **Prompt/context provenance and integrity tracking** under an approved and auditable VEYRA workflow.
