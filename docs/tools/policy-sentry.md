...
## What is it?
Advanced cloud capability: Policy Sentry
...
Use it when the security objective matches **Advanced cloud capability: Policy Sentry** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Policy Sentry** and read this guide before execution.
...
**One sentence:** Policy Sentry is used to help the team achieve **Advanced cloud capability: Policy Sentry** under an approved and auditable VEYRA workflow.
