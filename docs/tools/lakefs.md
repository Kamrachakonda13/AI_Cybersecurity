...
**Purpose:** Data versioning and lineage connector  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Data versioning and lineage connector
...
Use it when the security objective matches **Data versioning and lineage connector** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **lakefs** and read this guide before execution.
...
**One sentence:** lakefs is used to help the team achieve **Data versioning and lineage connector** under an approved and auditable VEYRA workflow.
