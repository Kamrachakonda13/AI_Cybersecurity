...
Use it when the security objective matches **Terraform security analysis** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **tfsec** and read this guide before execution.
...
**One sentence:** tfsec is used to help the team achieve **Terraform security analysis** under an approved and auditable VEYRA workflow.
