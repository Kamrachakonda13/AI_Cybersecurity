...
## What is it?
Kali security utility: enum4linux-ng
...
Use it when the security objective matches **Kali security utility: enum4linux-ng** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **enum4linux-ng** and read this guide before execution.
...
**One sentence:** enum4linux-ng is used to help the team achieve **Kali security utility: enum4linux-ng** under an approved and auditable VEYRA workflow.
