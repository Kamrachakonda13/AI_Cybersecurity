...
## What is it?
Kali security utility: llm-tools-nmap
...
Use it when the security objective matches **Kali security utility: llm-tools-nmap** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **llm-tools-nmap** and read this guide before execution.
...
**One sentence:** llm-tools-nmap is used to help the team achieve **Kali security utility: llm-tools-nmap** under an approved and auditable VEYRA workflow.
