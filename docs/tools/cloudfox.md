...
## What is it?
Advanced cloud capability: CloudFox
...
Use it when the security objective matches **Advanced cloud capability: CloudFox** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **CloudFox** and read this guide before execution.
...
**One sentence:** CloudFox is used to help the team achieve **Advanced cloud capability: CloudFox** under an approved and auditable VEYRA workflow.
