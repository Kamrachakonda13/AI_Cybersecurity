...
## What is it?
Kali security utility: gitleaks
...
Use it when the security objective matches **Kali security utility: gitleaks** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** gitleaks is used to help the team achieve **Kali security utility: gitleaks** under an approved and auditable VEYRA workflow.
