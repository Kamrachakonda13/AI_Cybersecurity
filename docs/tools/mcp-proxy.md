...
**Purpose:** Policy enforcement/proxy integration for MCP traffic  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Policy enforcement/proxy integration for MCP traffic
...
Use it when the security objective matches **Policy enforcement/proxy integration for MCP traffic** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **mcp-proxy** and read this guide before execution.
...
**One sentence:** mcp-proxy is used to help the team achieve **Policy enforcement/proxy integration for MCP traffic** under an approved and auditable VEYRA workflow.
