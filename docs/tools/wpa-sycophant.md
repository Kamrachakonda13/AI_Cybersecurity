...
## What is it?
Kali security utility: wpa-sycophant
...
Use it when the security objective matches **Kali security utility: wpa-sycophant** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **wpa-sycophant** and read this guide before execution.
...
**One sentence:** wpa-sycophant is used to help the team achieve **Kali security utility: wpa-sycophant** under an approved and auditable VEYRA workflow.
