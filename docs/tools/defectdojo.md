...
## What is it?
Kali security utility: defectdojo
...
Use it when the security objective matches **Kali security utility: defectdojo** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** defectdojo is used to help the team achieve **Kali security utility: defectdojo** under an approved and auditable VEYRA workflow.
