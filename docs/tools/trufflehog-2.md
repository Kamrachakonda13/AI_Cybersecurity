...
## What is it?
Advanced appsec capability: TruffleHog
...
Use it when the security objective matches **Advanced appsec capability: TruffleHog** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **TruffleHog** and read this guide before execution.
...
**One sentence:** TruffleHog is used to help the team achieve **Advanced appsec capability: TruffleHog** under an approved and auditable VEYRA workflow.
