...
**Purpose:** Inspect and test MCP servers and tool interfaces  
**VEYRA access:** admin  
**Execution boundary:** isolated_lab_only

## What is it?
Inspect and test MCP servers and tool interfaces
...
Use it when the security objective matches **Inspect and test MCP servers and tool interfaces** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **MCP Inspector** and read this guide before execution.
...
**One sentence:** MCP Inspector is used to help the team achieve **Inspect and test MCP servers and tool interfaces** under an approved and auditable VEYRA workflow.
