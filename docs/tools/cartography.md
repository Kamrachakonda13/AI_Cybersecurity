...
## What is it?
Advanced cloud capability: Cartography
...
Use it when the security objective matches **Advanced cloud capability: Cartography** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Cartography** and read this guide before execution.
...
**One sentence:** Cartography is used to help the team achieve **Advanced cloud capability: Cartography** under an approved and auditable VEYRA workflow.
