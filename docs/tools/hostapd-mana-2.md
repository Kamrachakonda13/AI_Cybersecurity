...
## What is it?
Advanced wireless capability: Hostapd-MANA
...
Use it when the security objective matches **Advanced wireless capability: Hostapd-MANA** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Hostapd-MANA** and read this guide before execution.
...
**One sentence:** Hostapd-MANA is used to help the team achieve **Advanced wireless capability: Hostapd-MANA** under an approved and auditable VEYRA workflow.
