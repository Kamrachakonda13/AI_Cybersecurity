...
## What is it?
Kali security utility: faraday-cli
...
Use it when the security objective matches **Kali security utility: faraday-cli** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **faraday-cli** and read this guide before execution.
...
**One sentence:** faraday-cli is used to help the team achieve **Kali security utility: faraday-cli** under an approved and auditable VEYRA workflow.
