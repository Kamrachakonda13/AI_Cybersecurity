...
## What is it?
Kali security utility: gemini-cli
...
Use it when the security objective matches **Kali security utility: gemini-cli** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **gemini-cli** and read this guide before execution.
...
**One sentence:** gemini-cli is used to help the team achieve **Kali security utility: gemini-cli** under an approved and auditable VEYRA workflow.
