...
## What is it?
Kali security utility: sploitscan
...
Use it when the security objective matches **Kali security utility: sploitscan** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **sploitscan** and read this guide before execution.
...
**One sentence:** sploitscan is used to help the team achieve **Kali security utility: sploitscan** under an approved and auditable VEYRA workflow.
