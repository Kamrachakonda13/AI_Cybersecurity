...
Use it when the security objective matches **Kali security utility: ivre** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** ivre is used to help the team achieve **Kali security utility: ivre** under an approved and auditable VEYRA workflow.
