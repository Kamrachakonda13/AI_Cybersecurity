...
## What is it?
Advanced wireless capability: Proxmark3
...
Use it when the security objective matches **Advanced wireless capability: Proxmark3** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Proxmark3** and read this guide before execution.
...
**One sentence:** Proxmark3 is used to help the team achieve **Advanced wireless capability: Proxmark3** under an approved and auditable VEYRA workflow.
