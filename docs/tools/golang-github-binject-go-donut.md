...
## What is it?
Kali security utility: golang-github-binject-go-donut
...
Use it when the security objective matches **Kali security utility: golang-github-binject-go-donut** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **golang-github-binject-go-donut** and read this guide before execution.
...
```bash
golang-github-binject-go-donut --help
golang-github-binject-go-donut --version
```
...
**One sentence:** golang-github-binject-go-donut is used to help the team achieve **Kali security utility: golang-github-binject-go-donut** under an approved and auditable VEYRA workflow.
