...
Use it when the security objective matches **Authorized authentication testing** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Medusa** and read this guide before execution.
...
**One sentence:** Medusa is used to help the team achieve **Authorized authentication testing** under an approved and auditable VEYRA workflow.
