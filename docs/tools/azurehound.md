...
## What is it?
Kali security utility: azurehound
...
Use it when the security objective matches **Kali security utility: azurehound** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **azurehound** and read this guide before execution.
...
**One sentence:** azurehound is used to help the team achieve **Kali security utility: azurehound** under an approved and auditable VEYRA workflow.
