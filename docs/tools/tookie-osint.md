...
## What is it?
Kali security utility: tookie-osint
...
Use it when the security objective matches **Kali security utility: tookie-osint** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **tookie-osint** and read this guide before execution.
...
**One sentence:** tookie-osint is used to help the team achieve **Kali security utility: tookie-osint** under an approved and auditable VEYRA workflow.
