...
Use it when the security objective matches **Code security analysis** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **CodeQL** and read this guide before execution.
...
**One sentence:** CodeQL is used to help the team achieve **Code security analysis** under an approved and auditable VEYRA workflow.
