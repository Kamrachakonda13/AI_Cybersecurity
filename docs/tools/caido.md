...
Use it when the security objective matches **Kali security utility: caido** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **caido** and read this guide before execution.
...
**One sentence:** caido is used to help the team achieve **Kali security utility: caido** under an approved and auditable VEYRA workflow.
