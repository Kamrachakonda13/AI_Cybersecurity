...
## What is it?
Advanced wireless capability: WiFi Pineapple
...
Use it when the security objective matches **Advanced wireless capability: WiFi Pineapple** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **WiFi Pineapple** and read this guide before execution.
...
**One sentence:** WiFi Pineapple is used to help the team achieve **Advanced wireless capability: WiFi Pineapple** under an approved and auditable VEYRA workflow.
