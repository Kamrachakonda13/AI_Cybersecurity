...
## What is it?
Kali security utility: autorecon
...
Use it when the security objective matches **Kali security utility: autorecon** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **autorecon** and read this guide before execution.
...
**One sentence:** autorecon is used to help the team achieve **Kali security utility: autorecon** under an approved and auditable VEYRA workflow.
