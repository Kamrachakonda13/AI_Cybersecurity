...
Use it when the security objective matches **Passive asset discovery** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Assetfinder** and read this guide before execution.
...
**One sentence:** Assetfinder is used to help the team achieve **Passive asset discovery** under an approved and auditable VEYRA workflow.
