...
Use it when the security objective matches **Kali security utility: fatcat** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **fatcat** and read this guide before execution.
...
**One sentence:** fatcat is used to help the team achieve **Kali security utility: fatcat** under an approved and auditable VEYRA workflow.
