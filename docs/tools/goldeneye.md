...
## What is it?
Kali security utility: goldeneye
...
Use it when the security objective matches **Kali security utility: goldeneye** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **goldeneye** and read this guide before execution.
...
**One sentence:** goldeneye is used to help the team achieve **Kali security utility: goldeneye** under an approved and auditable VEYRA workflow.
