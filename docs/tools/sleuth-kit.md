...
Use it when the security objective matches **Filesystem forensics** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Sleuth Kit** and read this guide before execution.
...
**One sentence:** Sleuth Kit is used to help the team achieve **Filesystem forensics** under an approved and auditable VEYRA workflow.
