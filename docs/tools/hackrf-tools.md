...
## What is it?
Advanced wireless capability: HackRF tools
...
Use it when the security objective matches **Advanced wireless capability: HackRF tools** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **HackRF tools** and read this guide before execution.
...
**One sentence:** HackRF tools is used to help the team achieve **Advanced wireless capability: HackRF tools** under an approved and auditable VEYRA workflow.
