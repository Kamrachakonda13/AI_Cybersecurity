...
## What is it?
Kali security utility: teamsploit
...
Use it when the security objective matches **Kali security utility: teamsploit** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **teamsploit** and read this guide before execution.
...
**One sentence:** teamsploit is used to help the team achieve **Kali security utility: teamsploit** under an approved and auditable VEYRA workflow.
