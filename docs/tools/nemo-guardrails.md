...
Use it when the security objective matches **LLM guardrails/policy enforcement** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **NeMo Guardrails** and read this guide before execution.
...
**One sentence:** NeMo Guardrails is used to help the team achieve **LLM guardrails/policy enforcement** under an approved and auditable VEYRA workflow.
