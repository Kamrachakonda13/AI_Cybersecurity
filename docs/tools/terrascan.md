...
Use it when the security objective matches **Infrastructure-as-code security** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Terrascan** and read this guide before execution.
...
## Safe workflow
Scan approved infrastructure definitions before deployment; prioritize identity, public exposure, secrets and encryption controls.
...
**One sentence:** Terrascan is used to help the team achieve **Infrastructure-as-code security** under an approved and auditable VEYRA workflow.
