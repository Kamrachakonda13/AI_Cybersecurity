...
Use it when the security objective matches **Kubernetes security assessment** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **kube-hunter** and read this guide before execution.
...
**One sentence:** kube-hunter is used to help the team achieve **Kubernetes security assessment** under an approved and auditable VEYRA workflow.
