...
Use it when the security objective matches **Kali security utility: ismtp** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ismtp** and read this guide before execution.
...
**One sentence:** ismtp is used to help the team achieve **Kali security utility: ismtp** under an approved and auditable VEYRA workflow.
