...
## What is it?
Kali security utility: kubernetes-helm
...
Use it when the security objective matches **Kali security utility: kubernetes-helm** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **kubernetes-helm** and read this guide before execution.
...
## Safe workflow
Assess an approved cluster with least-privilege credentials, benchmark posture, inspect risky workloads/services, and preserve evidence.
...
**One sentence:** kubernetes-helm is used to help the team achieve **Kali security utility: kubernetes-helm** under an approved and auditable VEYRA workflow.
