...
## What is it?
Kali security utility: kustomize
...
Use it when the security objective matches **Kali security utility: kustomize** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **kustomize** and read this guide before execution.
...
**One sentence:** kustomize is used to help the team achieve **Kali security utility: kustomize** under an approved and auditable VEYRA workflow.
