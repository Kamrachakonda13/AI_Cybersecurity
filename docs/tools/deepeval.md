...
## What is it?
Advanced ai security capability: DeepEval
...
Use it when the security objective matches **Advanced ai security capability: DeepEval** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **DeepEval** and read this guide before execution.
...
**One sentence:** DeepEval is used to help the team achieve **Advanced ai security capability: DeepEval** under an approved and auditable VEYRA workflow.
