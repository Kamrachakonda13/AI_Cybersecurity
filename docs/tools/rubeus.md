...
Use it when the security objective matches **Kali security utility: rubeus** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** rubeus is used to help the team achieve **Kali security utility: rubeus** under an approved and auditable VEYRA workflow.
