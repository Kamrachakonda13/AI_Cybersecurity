...
**Category:** AI AppSec  
**Purpose:** AI-assisted static analysis integration  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
AI-assisted static analysis integration
...
Use it when the security objective matches **AI-assisted static analysis integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **semgrep-ai** and read this guide before execution.
...
**One sentence:** semgrep-ai is used to help the team achieve **AI-assisted static analysis integration** under an approved and auditable VEYRA workflow.
