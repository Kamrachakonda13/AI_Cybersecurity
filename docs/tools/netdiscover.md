...
Use it when the security objective matches **LAN discovery** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Netdiscover** and read this guide before execution.
...
**One sentence:** Netdiscover is used to help the team achieve **LAN discovery** under an approved and auditable VEYRA workflow.
