...
Use it when the security objective matches **Kerberos identity assessment** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Kerbrute** and read this guide before execution.
...
**One sentence:** Kerbrute is used to help the team achieve **Kerberos identity assessment** under an approved and auditable VEYRA workflow.
