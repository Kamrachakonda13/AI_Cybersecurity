...
**Purpose:** Agent-to-agent identity and authorization assessment  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Agent-to-agent identity and authorization assessment
...
Use it when the security objective matches **Agent-to-agent identity and authorization assessment** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **a2a-security** and read this guide before execution.
...
**One sentence:** a2a-security is used to help the team achieve **Agent-to-agent identity and authorization assessment** under an approved and auditable VEYRA workflow.
