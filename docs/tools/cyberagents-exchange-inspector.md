...
**Purpose:** Security review integration for community AI components  
**VEYRA access:** admin  
**Execution boundary:** approved_connector

## What is it?
Security review integration for community AI components
...
Use it when the security objective matches **Security review integration for community AI components** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **CyberAgents Exchange AI Inspector** and read this guide before execution.
...
```bash
CyberAgents Exchange AI Inspector --help
CyberAgents Exchange AI Inspector --version
```
...
**One sentence:** CyberAgents Exchange AI Inspector is used to help the team achieve **Security review integration for community AI components** under an approved and auditable VEYRA workflow.
