...
## What is it?
Advanced web/api capability: Arjun
...
Use it when the security objective matches **Advanced web/api capability: Arjun** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Arjun** and read this guide before execution.
...
**One sentence:** Arjun is used to help the team achieve **Advanced web/api capability: Arjun** under an approved and auditable VEYRA workflow.
