...
## What is it?
Kali security utility: gowitness
...
Use it when the security objective matches **Kali security utility: gowitness** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **gowitness** and read this guide before execution.
...
**One sentence:** gowitness is used to help the team achieve **Kali security utility: gowitness** under an approved and auditable VEYRA workflow.
