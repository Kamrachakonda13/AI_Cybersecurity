...
**Purpose:** Adversarial robustness evaluation  
**VEYRA access:** admin  
...
Use it when the security objective matches **Adversarial robustness evaluation** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Foolbox** and read this guide before execution.
...
**One sentence:** Foolbox is used to help the team achieve **Adversarial robustness evaluation** under an approved and auditable VEYRA workflow.
