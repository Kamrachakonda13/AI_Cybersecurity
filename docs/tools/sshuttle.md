...
## What is it?
Kali security utility: sshuttle
...
Use it when the security objective matches **Kali security utility: sshuttle** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **sshuttle** and read this guide before execution.
...
**One sentence:** sshuttle is used to help the team achieve **Kali security utility: sshuttle** under an approved and auditable VEYRA workflow.
