...
## What is it?
Kali security utility: robotstxt
...
Use it when the security objective matches **Kali security utility: robotstxt** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **robotstxt** and read this guide before execution.
...
**One sentence:** robotstxt is used to help the team achieve **Kali security utility: robotstxt** under an approved and auditable VEYRA workflow.
