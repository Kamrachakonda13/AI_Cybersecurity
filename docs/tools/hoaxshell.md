...
## What is it?
Kali security utility: hoaxshell
...
Use it when the security objective matches **Kali security utility: hoaxshell** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **hoaxshell** and read this guide before execution.
...
**One sentence:** hoaxshell is used to help the team achieve **Kali security utility: hoaxshell** under an approved and auditable VEYRA workflow.
