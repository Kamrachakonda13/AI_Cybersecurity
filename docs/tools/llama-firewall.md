...
**Category:** AI Gateway  
**Purpose:** Runtime guardrails and policy enforcement for LLM applications  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Runtime guardrails and policy enforcement for LLM applications
...
Use it when the security objective matches **Runtime guardrails and policy enforcement for LLM applications** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **LlamaFirewall** and read this guide before execution.
...
**One sentence:** LlamaFirewall is used to help the team achieve **Runtime guardrails and policy enforcement for LLM applications** under an approved and auditable VEYRA workflow.
