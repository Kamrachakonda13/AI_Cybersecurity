...
## What is it?
Advanced security utilities capability: Samba-tool
...
Use it when the security objective matches **Advanced security utilities capability: Samba-tool** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Samba-tool** and read this guide before execution.
...
**One sentence:** Samba-tool is used to help the team achieve **Advanced security utilities capability: Samba-tool** under an approved and auditable VEYRA workflow.
