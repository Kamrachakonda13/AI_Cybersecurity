...
## What is it?
Kali security utility: proximoth
...
Use it when the security objective matches **Kali security utility: proximoth** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **proximoth** and read this guide before execution.
...
**One sentence:** proximoth is used to help the team achieve **Kali security utility: proximoth** under an approved and auditable VEYRA workflow.
