...
## What is it?
Kali security utility: gospider
...
Use it when the security objective matches **Kali security utility: gospider** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **gospider** and read this guide before execution.
...
**One sentence:** gospider is used to help the team achieve **Kali security utility: gospider** under an approved and auditable VEYRA workflow.
