...
## What is it?
Kali security utility: bloodhound
...
Use it when the security objective matches **Kali security utility: bloodhound** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** bloodhound is used to help the team achieve **Kali security utility: bloodhound** under an approved and auditable VEYRA workflow.
