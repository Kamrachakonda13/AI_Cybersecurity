...
## What is it?
Advanced ai security capability: Fickling
...
Use it when the security objective matches **Advanced ai security capability: Fickling** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Fickling** and read this guide before execution.
...
**One sentence:** Fickling is used to help the team achieve **Advanced ai security capability: Fickling** under an approved and auditable VEYRA workflow.
