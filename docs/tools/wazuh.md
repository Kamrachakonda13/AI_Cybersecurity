...
## What is it?
Advanced endpoint capability: Wazuh
...
Use it when the security objective matches **Advanced endpoint capability: Wazuh** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Wazuh** and read this guide before execution.
...
**One sentence:** Wazuh is used to help the team achieve **Advanced endpoint capability: Wazuh** under an approved and auditable VEYRA workflow.
