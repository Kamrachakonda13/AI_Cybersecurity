...
2. Search for **Dirsearch** and read this guide before execution.
...
**One sentence:** Dirsearch is used to help the team achieve **Content discovery** under an approved and auditable VEYRA workflow.
