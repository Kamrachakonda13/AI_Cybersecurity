...
## What is it?
Kali security utility: airgeddon
...
Use it when the security objective matches **Kali security utility: airgeddon** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** airgeddon is used to help the team achieve **Kali security utility: airgeddon** under an approved and auditable VEYRA workflow.
