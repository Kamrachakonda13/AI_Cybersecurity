...
Use it when the security objective matches **LLM security evaluation** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Garak** and read this guide before execution.
...
**One sentence:** Garak is used to help the team achieve **LLM security evaluation** under an approved and auditable VEYRA workflow.
