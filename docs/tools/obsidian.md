...
## What is it?
Kali security utility: obsidian
...
Use it when the security objective matches **Kali security utility: obsidian** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **obsidian** and read this guide before execution.
...
**One sentence:** obsidian is used to help the team achieve **Kali security utility: obsidian** under an approved and auditable VEYRA workflow.
