...
## What is it?
Advanced web/api capability: Katana
...
Use it when the security objective matches **Advanced web/api capability: Katana** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Katana** and read this guide before execution.
...
**One sentence:** Katana is used to help the team achieve **Advanced web/api capability: Katana** under an approved and auditable VEYRA workflow.
