...
## What is it?
Authorized password-strength auditing
...
Use it when the security objective matches **Authorized password-strength auditing** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **John the Ripper** and read this guide before execution.
...
**One sentence:** John the Ripper is used to help the team achieve **Authorized password-strength auditing** under an approved and auditable VEYRA workflow.
