...
## What is it?
Advanced identity capability: Rubeus
...
Use it when the security objective matches **Advanced identity capability: Rubeus** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Rubeus** and read this guide before execution.
...
**One sentence:** Rubeus is used to help the team achieve **Advanced identity capability: Rubeus** under an approved and auditable VEYRA workflow.
