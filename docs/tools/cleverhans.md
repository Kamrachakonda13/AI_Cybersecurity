...
**Purpose:** Adversarial machine-learning research framework  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Adversarial machine-learning research framework
...
Use it when the security objective matches **Adversarial machine-learning research framework** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **cleverhans** and read this guide before execution.
...
**One sentence:** cleverhans is used to help the team achieve **Adversarial machine-learning research framework** under an approved and auditable VEYRA workflow.
