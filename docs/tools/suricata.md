...
Use it when the security objective matches **IDS/NSM** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Suricata** and read this guide before execution.
...
**One sentence:** Suricata is used to help the team achieve **IDS/NSM** under an approved and auditable VEYRA workflow.
