...
**Category:** AI Secrets  
**Purpose:** Secrets detection connector  
**VEYRA access:** admin  
...
Use it when the security objective matches **Secrets detection connector** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **gitguardian** and read this guide before execution.
...
**One sentence:** gitguardian is used to help the team achieve **Secrets detection connector** under an approved and auditable VEYRA workflow.
