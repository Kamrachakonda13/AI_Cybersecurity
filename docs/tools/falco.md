...
Use it when the security objective matches **Runtime detection** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Falco** and read this guide before execution.
...
**One sentence:** Falco is used to help the team achieve **Runtime detection** under an approved and auditable VEYRA workflow.
