...
## What is it?
SBOM/image vulnerability scanning
...
Use it when the security objective matches **SBOM/image vulnerability scanning** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Grype** and read this guide before execution.
...
**One sentence:** Grype is used to help the team achieve **SBOM/image vulnerability scanning** under an approved and auditable VEYRA workflow.
