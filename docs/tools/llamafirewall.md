...
## What is it?
Advanced security utilities capability: LlamaFirewall
...
Use it when the security objective matches **Advanced security utilities capability: LlamaFirewall** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** LlamaFirewall is used to help the team achieve **Advanced security utilities capability: LlamaFirewall** under an approved and auditable VEYRA workflow.
