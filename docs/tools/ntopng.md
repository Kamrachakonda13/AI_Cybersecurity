...
## What is it?
Advanced network discovery capability: ntopng
...
Use it when the security objective matches **Advanced network discovery capability: ntopng** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ntopng** and read this guide before execution.
...
**One sentence:** ntopng is used to help the team achieve **Advanced network discovery capability: ntopng** under an approved and auditable VEYRA workflow.
