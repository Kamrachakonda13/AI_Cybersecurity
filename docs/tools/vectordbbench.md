...
**Purpose:** Vector database performance/security test harness  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Vector database performance/security test harness
...
Use it when the security objective matches **Vector database performance/security test harness** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **vectordbbench** and read this guide before execution.
...
**One sentence:** vectordbbench is used to help the team achieve **Vector database performance/security test harness** under an approved and auditable VEYRA workflow.
