...
## What is it?
Kali security utility: sparrow-wifi
...
Use it when the security objective matches **Kali security utility: sparrow-wifi** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **sparrow-wifi** and read this guide before execution.
...
**One sentence:** sparrow-wifi is used to help the team achieve **Kali security utility: sparrow-wifi** under an approved and auditable VEYRA workflow.
