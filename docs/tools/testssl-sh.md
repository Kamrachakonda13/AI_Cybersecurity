...
## What is it?
Kali security utility: testssl.sh
...
Use it when the security objective matches **Kali security utility: testssl.sh** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **testssl.sh** and read this guide before execution.
...
**One sentence:** testssl.sh is used to help the team achieve **Kali security utility: testssl.sh** under an approved and auditable VEYRA workflow.
