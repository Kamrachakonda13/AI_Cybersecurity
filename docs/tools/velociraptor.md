...
Use it when the security objective matches **Endpoint investigation** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Velociraptor** and read this guide before execution.
...
**One sentence:** Velociraptor is used to help the team achieve **Endpoint investigation** under an approved and auditable VEYRA workflow.
