...
## What is it?
Kali security utility: spraykatz
...
Use it when the security objective matches **Kali security utility: spraykatz** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **spraykatz** and read this guide before execution.
...
**One sentence:** spraykatz is used to help the team achieve **Kali security utility: spraykatz** under an approved and auditable VEYRA workflow.
