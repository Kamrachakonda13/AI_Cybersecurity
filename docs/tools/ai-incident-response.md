...
**Purpose:** AI incident evidence/response workflow integration  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
AI incident evidence/response workflow integration
...
Use it when the security objective matches **AI incident evidence/response workflow integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ai-incident-response** and read this guide before execution.
...
```bash
ai-incident-response --help
ai-incident-response --version
```
...
**One sentence:** ai-incident-response is used to help the team achieve **AI incident evidence/response workflow integration** under an approved and auditable VEYRA workflow.
