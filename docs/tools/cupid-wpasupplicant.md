...
## What is it?
Kali security utility: cupid-wpasupplicant
...
Use it when the security objective matches **Kali security utility: cupid-wpasupplicant** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **cupid-wpasupplicant** and read this guide before execution.
...
```bash
cupid-wpasupplicant --help
cupid-wpasupplicant --version
```
...
**One sentence:** cupid-wpasupplicant is used to help the team achieve **Kali security utility: cupid-wpasupplicant** under an approved and auditable VEYRA workflow.
