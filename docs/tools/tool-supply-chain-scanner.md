...
**Purpose:** Scan skills, MCP servers and tool definitions for risk  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Scan skills, MCP servers and tool definitions for risk
...
Use it when the security objective matches **Scan skills, MCP servers and tool definitions for risk** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **tool-supply-chain-scanner** and read this guide before execution.
...
```bash
tool-supply-chain-scanner --help
tool-supply-chain-scanner --version
```
...
**One sentence:** tool-supply-chain-scanner is used to help the team achieve **Scan skills, MCP servers and tool definitions for risk** under an approved and auditable VEYRA workflow.
