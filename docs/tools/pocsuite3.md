...
## What is it?
Kali security utility: pocsuite3
...
Use it when the security objective matches **Kali security utility: pocsuite3** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **pocsuite3** and read this guide before execution.
...
**One sentence:** pocsuite3 is used to help the team achieve **Kali security utility: pocsuite3** under an approved and auditable VEYRA workflow.
