...
## What is it?
Advanced web/api capability: Kiterunner
...
Use it when the security objective matches **Advanced web/api capability: Kiterunner** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Kiterunner** and read this guide before execution.
...
**One sentence:** Kiterunner is used to help the team achieve **Advanced web/api capability: Kiterunner** under an approved and auditable VEYRA workflow.
