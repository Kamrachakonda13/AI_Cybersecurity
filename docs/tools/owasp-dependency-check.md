...
## What is it?
Advanced appsec capability: OWASP Dependency-Check
...
Use it when the security objective matches **Advanced appsec capability: OWASP Dependency-Check** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **OWASP Dependency-Check** and read this guide before execution.
...
**One sentence:** OWASP Dependency-Check is used to help the team achieve **Advanced appsec capability: OWASP Dependency-Check** under an approved and auditable VEYRA workflow.
