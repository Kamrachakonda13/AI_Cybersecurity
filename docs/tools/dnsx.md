...
Use it when the security objective matches **DNS validation** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **dnsx** and read this guide before execution.
...
**One sentence:** dnsx is used to help the team achieve **DNS validation** under an approved and auditable VEYRA workflow.
