...
## What is it?
Kali security utility: feroxbuster
...
Use it when the security objective matches **Kali security utility: feroxbuster** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **feroxbuster** and read this guide before execution.
...
**One sentence:** feroxbuster is used to help the team achieve **Kali security utility: feroxbuster** under an approved and auditable VEYRA workflow.
