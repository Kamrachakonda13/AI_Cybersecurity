...
## What is it?
Advanced kubernetes capability: Hubble
...
Use it when the security objective matches **Advanced kubernetes capability: Hubble** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Hubble** and read this guide before execution.
...
**One sentence:** Hubble is used to help the team achieve **Advanced kubernetes capability: Hubble** under an approved and auditable VEYRA workflow.
