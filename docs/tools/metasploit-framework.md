...
Use it when the security objective matches **Authorized vulnerability validation** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Metasploit Framework** and read this guide before execution.
...
**One sentence:** Metasploit Framework is used to help the team achieve **Authorized vulnerability validation** under an approved and auditable VEYRA workflow.
