...
**Purpose:** RAG/agent application integration and evaluation  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
RAG/agent application integration and evaluation
...
Use it when the security objective matches **RAG/agent application integration and evaluation** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **LlamaIndex** and read this guide before execution.
...
**One sentence:** LlamaIndex is used to help the team achieve **RAG/agent application integration and evaluation** under an approved and auditable VEYRA workflow.
