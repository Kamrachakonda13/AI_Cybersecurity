...
## What is it?
Advanced endpoint capability: Security Onion
...
Use it when the security objective matches **Advanced endpoint capability: Security Onion** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Security Onion** and read this guide before execution.
...
## Safe workflow
Use the managed collector/agent on consented endpoints, collect telemetry, investigate anomalies, and avoid arbitrary remote execution.
...
**One sentence:** Security Onion is used to help the team achieve **Advanced endpoint capability: Security Onion** under an approved and auditable VEYRA workflow.
