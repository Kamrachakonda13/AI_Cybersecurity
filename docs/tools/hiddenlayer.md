...
## What is it?
AI model security platform integration
...
Use it when the security objective matches **AI model security platform integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **HiddenLayer** and read this guide before execution.
...
**One sentence:** HiddenLayer is used to help the team achieve **AI model security platform integration** under an approved and auditable VEYRA workflow.
