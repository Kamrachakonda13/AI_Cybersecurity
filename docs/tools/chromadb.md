...
**Category:** Vector DB  
**Purpose:** Vector database security connector  
**VEYRA access:** admin  
...
2. Search for **chromadb** and read this guide before execution.
...
**One sentence:** chromadb is used to help the team achieve **Vector database security connector** under an approved and auditable VEYRA workflow.
