...
## What is it?
Advanced ai security capability: ModelScan CLI
...
Use it when the security objective matches **Advanced ai security capability: ModelScan CLI** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ModelScan CLI** and read this guide before execution.
...
**One sentence:** ModelScan CLI is used to help the team achieve **Advanced ai security capability: ModelScan CLI** under an approved and auditable VEYRA workflow.
