...
## What is it?
Advanced identity capability: Coercer
...
Use it when the security objective matches **Advanced identity capability: Coercer** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Coercer** and read this guide before execution.
...
**One sentence:** Coercer is used to help the team achieve **Advanced identity capability: Coercer** under an approved and auditable VEYRA workflow.
