...
**Purpose:** Controlled testing of agent-to-agent identity and message trust  
**VEYRA access:** admin  
**Execution boundary:** isolated_lab_only

## What is it?
Controlled testing of agent-to-agent identity and message trust
...
Use it when the security objective matches **Controlled testing of agent-to-agent identity and message trust** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **A2A Security Test Suite** and read this guide before execution.
...
```bash
A2A Security Test Suite --help
A2A Security Test Suite --version
```
...
**One sentence:** A2A Security Test Suite is used to help the team achieve **Controlled testing of agent-to-agent identity and message trust** under an approved and auditable VEYRA workflow.
