...
Use it when the security objective matches **Kali security utility: bopscrk** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **bopscrk** and read this guide before execution.
...
**One sentence:** bopscrk is used to help the team achieve **Kali security utility: bopscrk** under an approved and auditable VEYRA workflow.
