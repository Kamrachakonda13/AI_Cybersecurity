...
## What is it?
Advanced appsec capability: OSV-Scanner
...
Use it when the security objective matches **Advanced appsec capability: OSV-Scanner** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** OSV-Scanner is used to help the team achieve **Advanced appsec capability: OSV-Scanner** under an approved and auditable VEYRA workflow.
