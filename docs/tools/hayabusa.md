...
## What is it?
Advanced dfir capability: Hayabusa
...
Use it when the security objective matches **Advanced dfir capability: Hayabusa** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Hayabusa** and read this guide before execution.
...
**One sentence:** Hayabusa is used to help the team achieve **Advanced dfir capability: Hayabusa** under an approved and auditable VEYRA workflow.
