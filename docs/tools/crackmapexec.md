...
## What is it?
Kali security utility: crackmapexec
...
Use it when the security objective matches **Kali security utility: crackmapexec** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **crackmapexec** and read this guide before execution.
...
**One sentence:** crackmapexec is used to help the team achieve **Kali security utility: crackmapexec** under an approved and auditable VEYRA workflow.
