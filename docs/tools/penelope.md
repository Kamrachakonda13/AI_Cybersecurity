...
## What is it?
Kali security utility: penelope
...
Use it when the security objective matches **Kali security utility: penelope** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **penelope** and read this guide before execution.
...
**One sentence:** penelope is used to help the team achieve **Kali security utility: penelope** under an approved and auditable VEYRA workflow.
