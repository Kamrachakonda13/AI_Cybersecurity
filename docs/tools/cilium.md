...
## What is it?
Advanced kubernetes capability: Cilium
...
Use it when the security objective matches **Advanced kubernetes capability: Cilium** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Cilium** and read this guide before execution.
...
**One sentence:** Cilium is used to help the team achieve **Advanced kubernetes capability: Cilium** under an approved and auditable VEYRA workflow.
