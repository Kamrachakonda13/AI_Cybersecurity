...
Use it when the security objective matches **Windows endpoint telemetry** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Sysmon** and read this guide before execution.
...
**One sentence:** Sysmon is used to help the team achieve **Windows endpoint telemetry** under an approved and auditable VEYRA workflow.
