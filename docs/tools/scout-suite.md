...
Use it when the security objective matches **Multi-cloud security auditing** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Scout Suite** and read this guide before execution.
...
**One sentence:** Scout Suite is used to help the team achieve **Multi-cloud security auditing** under an approved and auditable VEYRA workflow.
