...
**Purpose:** RAG evaluation and retrieval-quality regression  
**VEYRA access:** admin  
...
2. Search for **Ragas** and read this guide before execution.
...
**One sentence:** Ragas is used to help the team achieve **RAG evaluation and retrieval-quality regression** under an approved and auditable VEYRA workflow.
