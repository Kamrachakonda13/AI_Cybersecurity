...
## What is it?
Authorized Windows/network assessment
...
Use it when the security objective matches **Authorized Windows/network assessment** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **NetExec** and read this guide before execution.
...
**One sentence:** NetExec is used to help the team achieve **Authorized Windows/network assessment** under an approved and auditable VEYRA workflow.
