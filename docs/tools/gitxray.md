...
Use it when the security objective matches **Kali security utility: gitxray** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **gitxray** and read this guide before execution.
...
**One sentence:** gitxray is used to help the team achieve **Kali security utility: gitxray** under an approved and auditable VEYRA workflow.
