...
**Purpose:** Vector database integration and security testing  
**VEYRA access:** admin  
**Execution boundary:** approved_connector

## What is it?
Vector database integration and security testing
...
Use it when the security objective matches **Vector database integration and security testing** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Weaviate** and read this guide before execution.
...
**One sentence:** Weaviate is used to help the team achieve **Vector database integration and security testing** under an approved and auditable VEYRA workflow.
