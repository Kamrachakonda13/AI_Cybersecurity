...
Use it when the security objective matches **Template-based vulnerability assessment** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** Nuclei is used to help the team achieve **Template-based vulnerability assessment** under an approved and auditable VEYRA workflow.
