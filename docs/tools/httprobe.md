...
## What is it?
Kali security utility: httprobe
...
Use it when the security objective matches **Kali security utility: httprobe** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **httprobe** and read this guide before execution.
...
**One sentence:** httprobe is used to help the team achieve **Kali security utility: httprobe** under an approved and auditable VEYRA workflow.
