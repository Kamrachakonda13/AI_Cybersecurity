...
**Category:** AI Secrets  
**Purpose:** Secret detection in AI/application repositories  
**VEYRA access:** admin  
**Execution boundary:** approved_worker

## What is it?
Secret detection in AI/application repositories
...
Use it when the security objective matches **Secret detection in AI/application repositories** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Gitleaks** and read this guide before execution.
...
**One sentence:** Gitleaks is used to help the team achieve **Secret detection in AI/application repositories** under an approved and auditable VEYRA workflow.
