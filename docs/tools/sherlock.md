...
## What is it?
Kali security utility: sherlock
...
Use it when the security objective matches **Kali security utility: sherlock** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **sherlock** and read this guide before execution.
...
**One sentence:** sherlock is used to help the team achieve **Kali security utility: sherlock** under an approved and auditable VEYRA workflow.
