...
**Purpose:** AI artifact and dependency inventory integration  
**VEYRA access:** admin  
**Execution boundary:** approved_worker

## What is it?
AI artifact and dependency inventory integration
...
Use it when the security objective matches **AI artifact and dependency inventory integration** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Syft AI/SBOM** and read this guide before execution.
...
**One sentence:** Syft AI/SBOM is used to help the team achieve **AI artifact and dependency inventory integration** under an approved and auditable VEYRA workflow.
