...
## What is it?
Kali security utility: instaloader
...
Use it when the security objective matches **Kali security utility: instaloader** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **instaloader** and read this guide before execution.
...
**One sentence:** instaloader is used to help the team achieve **Kali security utility: instaloader** under an approved and auditable VEYRA workflow.
