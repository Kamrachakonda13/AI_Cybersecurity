...
## What is it?
Kali security utility: ligolo-mp
...
Use it when the security objective matches **Kali security utility: ligolo-mp** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ligolo-mp** and read this guide before execution.
...
**One sentence:** ligolo-mp is used to help the team achieve **Kali security utility: ligolo-mp** under an approved and auditable VEYRA workflow.
