...
2. Search for **tshark** and read this guide before execution.
...
**One sentence:** tshark is used to help the team achieve **Packet analysis** under an approved and auditable VEYRA workflow.
