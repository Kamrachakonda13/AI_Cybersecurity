...
## What is it?
Kali security utility: shell-gpt
...
Use it when the security objective matches **Kali security utility: shell-gpt** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **shell-gpt** and read this guide before execution.
...
**One sentence:** shell-gpt is used to help the team achieve **Kali security utility: shell-gpt** under an approved and auditable VEYRA workflow.
