...
## What is it?
Kali security utility: hcxtools
...
Use it when the security objective matches **Kali security utility: hcxtools** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **hcxtools** and read this guide before execution.
...
**One sentence:** hcxtools is used to help the team achieve **Kali security utility: hcxtools** under an approved and auditable VEYRA workflow.
