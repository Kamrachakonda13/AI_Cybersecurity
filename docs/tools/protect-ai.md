...
## What is it?
Advanced ai security capability: Protect AI
...
Use it when the security objective matches **Advanced ai security capability: Protect AI** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Protect AI** and read this guide before execution.
...
**One sentence:** Protect AI is used to help the team achieve **Advanced ai security capability: Protect AI** under an approved and auditable VEYRA workflow.
