...
## What is it?
Kali security utility: merlin-agent
...
Use it when the security objective matches **Kali security utility: merlin-agent** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **merlin-agent** and read this guide before execution.
...
**One sentence:** merlin-agent is used to help the team achieve **Kali security utility: merlin-agent** under an approved and auditable VEYRA workflow.
