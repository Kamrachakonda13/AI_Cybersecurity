...
## What is it?
Advanced appsec capability: CycloneDX CLI
...
Use it when the security objective matches **Advanced appsec capability: CycloneDX CLI** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **CycloneDX CLI** and read this guide before execution.
...
**One sentence:** CycloneDX CLI is used to help the team achieve **Advanced appsec capability: CycloneDX CLI** under an approved and auditable VEYRA workflow.
