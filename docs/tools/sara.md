...
Use it when the security objective matches **Kali security utility: sara** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **sara** and read this guide before execution.
...
**One sentence:** sara is used to help the team achieve **Kali security utility: sara** under an approved and auditable VEYRA workflow.
