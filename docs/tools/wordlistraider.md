...
## What is it?
Kali security utility: wordlistraider
...
Use it when the security objective matches **Kali security utility: wordlistraider** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **wordlistraider** and read this guide before execution.
...
**One sentence:** wordlistraider is used to help the team achieve **Kali security utility: wordlistraider** under an approved and auditable VEYRA workflow.
