...
**Purpose:** Robustness benchmarking and reference models  
**VEYRA access:** admin  
**Execution boundary:** isolated_analysis_worker

## What is it?
Robustness benchmarking and reference models
...
Use it when the security objective matches **Robustness benchmarking and reference models** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **RobustBench** and read this guide before execution.
...
**One sentence:** RobustBench is used to help the team achieve **Robustness benchmarking and reference models** under an approved and auditable VEYRA workflow.
