...
Use it when the security objective matches **Kali security utility: pompem** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **pompem** and read this guide before execution.
...
**One sentence:** pompem is used to help the team achieve **Kali security utility: pompem** under an approved and auditable VEYRA workflow.
