...
## What is it?
Kali security utility: hb-honeypot
...
Use it when the security objective matches **Kali security utility: hb-honeypot** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **hb-honeypot** and read this guide before execution.
...
**One sentence:** hb-honeypot is used to help the team achieve **Kali security utility: hb-honeypot** under an approved and auditable VEYRA workflow.
