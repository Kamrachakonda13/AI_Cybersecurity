...
Use it when the security objective matches **LLM/agent evaluation** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Promptfoo** and read this guide before execution.
...
**One sentence:** Promptfoo is used to help the team achieve **LLM/agent evaluation** under an approved and auditable VEYRA workflow.
