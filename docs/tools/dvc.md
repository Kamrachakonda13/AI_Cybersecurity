...
**Purpose:** Dataset/model versioning and provenance  
**VEYRA access:** admin  
**Execution boundary:** approved_ai_worker

## What is it?
Dataset/model versioning and provenance
...
Use it when the security objective matches **Dataset/model versioning and provenance** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **dvc** and read this guide before execution.
...
**One sentence:** dvc is used to help the team achieve **Dataset/model versioning and provenance** under an approved and auditable VEYRA workflow.
