...
Use it when the security objective matches **Advanced dfir capability: CAPA** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** CAPA is used to help the team achieve **Advanced dfir capability: CAPA** under an approved and auditable VEYRA workflow.
