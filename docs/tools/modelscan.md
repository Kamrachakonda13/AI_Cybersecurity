...
## What is it?
Advanced ai security capability: ModelScan
...
Use it when the security objective matches **Advanced ai security capability: ModelScan** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ModelScan** and read this guide before execution.
...
**One sentence:** ModelScan is used to help the team achieve **Advanced ai security capability: ModelScan** under an approved and auditable VEYRA workflow.
