...
## What is it?
Kali security utility: pskracker
...
Use it when the security objective matches **Kali security utility: pskracker** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **pskracker** and read this guide before execution.
...
**One sentence:** pskracker is used to help the team achieve **Kali security utility: pskracker** under an approved and auditable VEYRA workflow.
