...
## What is it?
Kali security utility: dirbuster
...
Use it when the security objective matches **Kali security utility: dirbuster** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **dirbuster** and read this guide before execution.
...
**One sentence:** dirbuster is used to help the team achieve **Kali security utility: dirbuster** under an approved and auditable VEYRA workflow.
