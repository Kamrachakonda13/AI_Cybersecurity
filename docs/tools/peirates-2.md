...
## What is it?
Advanced kubernetes capability: Peirates
...
Use it when the security objective matches **Advanced kubernetes capability: Peirates** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Peirates** and read this guide before execution.
...
**One sentence:** Peirates is used to help the team achieve **Advanced kubernetes capability: Peirates** under an approved and auditable VEYRA workflow.
