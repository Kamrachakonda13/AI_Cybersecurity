...
Use it when the security objective matches **Kali security utility: subjack** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **subjack** and read this guide before execution.
...
**One sentence:** subjack is used to help the team achieve **Kali security utility: subjack** under an approved and auditable VEYRA workflow.
