...
## What is it?
Kali security utility: android-sdk
...
Use it when the security objective matches **Kali security utility: android-sdk** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **android-sdk** and read this guide before execution.
...
**One sentence:** android-sdk is used to help the team achieve **Kali security utility: android-sdk** under an approved and auditable VEYRA workflow.
