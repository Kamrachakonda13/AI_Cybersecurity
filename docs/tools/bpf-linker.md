...
## What is it?
Kali security utility: bpf-linker
...
Use it when the security objective matches **Kali security utility: bpf-linker** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **bpf-linker** and read this guide before execution.
...
**One sentence:** bpf-linker is used to help the team achieve **Kali security utility: bpf-linker** under an approved and auditable VEYRA workflow.
