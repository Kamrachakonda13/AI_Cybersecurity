...
## What is it?
Advanced cloud capability: ScoutSuite
...
Use it when the security objective matches **Advanced cloud capability: ScoutSuite** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **ScoutSuite** and read this guide before execution.
...
**One sentence:** ScoutSuite is used to help the team achieve **Advanced cloud capability: ScoutSuite** under an approved and auditable VEYRA workflow.
