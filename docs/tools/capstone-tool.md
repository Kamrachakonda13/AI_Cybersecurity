...
## What is it?
Kali security utility: capstone-tool
...
Use it when the security objective matches **Kali security utility: capstone-tool** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **capstone-tool** and read this guide before execution.
...
**One sentence:** capstone-tool is used to help the team achieve **Kali security utility: capstone-tool** under an approved and auditable VEYRA workflow.
