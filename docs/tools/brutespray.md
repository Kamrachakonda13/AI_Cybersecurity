...
## What is it?
Kali security utility: brutespray
...
Use it when the security objective matches **Kali security utility: brutespray** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **brutespray** and read this guide before execution.
...
**One sentence:** brutespray is used to help the team achieve **Kali security utility: brutespray** under an approved and auditable VEYRA workflow.
