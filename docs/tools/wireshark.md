...
Use it when the security objective matches **Packet analysis** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Wireshark** and read this guide before execution.
...
**One sentence:** Wireshark is used to help the team achieve **Packet analysis** under an approved and auditable VEYRA workflow.
