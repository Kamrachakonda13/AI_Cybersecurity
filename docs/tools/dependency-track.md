...
## What is it?
Advanced appsec capability: Dependency-Track
...
Use it when the security objective matches **Advanced appsec capability: Dependency-Track** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Dependency-Track** and read this guide before execution.
...
**One sentence:** Dependency-Track is used to help the team achieve **Advanced appsec capability: Dependency-Track** under an approved and auditable VEYRA workflow.
