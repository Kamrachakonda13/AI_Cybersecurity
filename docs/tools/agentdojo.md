...
## What is it?
Advanced ai security capability: AgentDojo
...
Use it when the security objective matches **Advanced ai security capability: AgentDojo** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **AgentDojo** and read this guide before execution.
...
**One sentence:** AgentDojo is used to help the team achieve **Advanced ai security capability: AgentDojo** under an approved and auditable VEYRA workflow.
