...
Use it when the security objective matches **Kali security utility: pacu** and the target is owned, explicitly authorized, and inside the recorded scope.
...
**One sentence:** pacu is used to help the team achieve **Kali security utility: pacu** under an approved and auditable VEYRA workflow.
