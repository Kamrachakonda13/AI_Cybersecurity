...
## What is it?
Kali security utility: caido-cli
...
Use it when the security objective matches **Kali security utility: caido-cli** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **caido-cli** and read this guide before execution.
...
**One sentence:** caido-cli is used to help the team achieve **Kali security utility: caido-cli** under an approved and auditable VEYRA workflow.
