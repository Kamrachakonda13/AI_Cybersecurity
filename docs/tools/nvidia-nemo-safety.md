...
## What is it?
Advanced ai security capability: NVIDIA NeMo Safety
...
Use it when the security objective matches **Advanced ai security capability: NVIDIA NeMo Safety** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **NVIDIA NeMo Safety** and read this guide before execution.
...
```bash
NVIDIA NeMo Safety --help
NVIDIA NeMo Safety --version
```
...
**One sentence:** NVIDIA NeMo Safety is used to help the team achieve **Advanced ai security capability: NVIDIA NeMo Safety** under an approved and auditable VEYRA workflow.
