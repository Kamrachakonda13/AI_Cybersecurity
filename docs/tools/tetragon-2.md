...
## What is it?
Advanced kubernetes capability: Tetragon
...
Use it when the security objective matches **Advanced kubernetes capability: Tetragon** and the target is owned, explicitly authorized, and inside the recorded scope.

## VEYRA UI workflow
1. Open **Tool Runner / Sudo Security Arsenal**.
2. Search for **Tetragon** and read this guide before execution.
...
**One sentence:** Tetragon is used to help the team achieve **Advanced kubernetes capability: Tetragon** under an approved and auditable VEYRA workflow.
