"""VEYRA source module `backend/tests/test_fabric_v20.py`. See `docs/CODEBASE_GUIDE_V27.md` for the module purpose, symbols, dependencies, and maintenance guidance."""
