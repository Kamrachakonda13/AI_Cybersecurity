...
TOOL_REGISTRY = [
    ...
    ("Masscan","Network Discovery","High-speed exposure inventory","lab_or_approved_worker"),
    ...
    # Web/API
    ("Burp Suite","Web/API","Web application security assessment","lab_or_approved_worker"),
    ("OWASP ZAP","Web/API","Web application security assessment","lab_or_approved_worker"),
    ("Nuclei","Web/API","Template-based vulnerability assessment","lab_or_approved_worker"),
    ...
    ("Metasploit Framework","Exploit Validation","Authorized vulnerability validation","isolated_lab_only"),
    ("Core Impact","Exploit Validation","Authorized penetration testing","isolated_lab_only"),
    ("Impacket","Identity/Network","Authorized protocol/security assessment","isolated_lab_only"),
    ("NetExec","Identity/Network","Authorized Windows/network assessment","isolated_lab_only"),
    ...
    ("Hashcat","Credential Audit","Authorized password-strength auditing","offline_audit_only"),
    ("John the Ripper","Credential Audit","Authorized password-strength auditing","offline_audit_only"),
    ("Hydra","Credential Audit","Authorized authentication testing","isolated_lab_only"),
    ("Medusa","Credential Audit","Authorized authentication testing","isolated_lab_only"),
    ...
    ("OpenVAS/Greenbone","Vulnerability","Vulnerability assessment","approved_worker"),
    ("Nessus","Vulnerability","Vulnerability assessment/import","approved_worker"),
    ("Trivy","Cloud/Container","Container/Kubernetes/package security","approved_worker"),
    ...
    ("Ghidra","Reverse Engineering","Static reverse engineering","isolated_analysis_worker"),
    ("radare2","Reverse Engineering","Static reverse engineering","isolated_analysis_worker"),
    ("Rizin","Reverse Engineering","Static reverse engineering","isolated_analysis_worker"),
    ...
    ("STIX/TAXII","Threat Intelligence","Threat-intel transport","approved_connector"),
    ("Sigma","Detection Engineering","Portable detection rules","approved_worker"),
    # AI security
    ("NeuralTrust","AI Security","Agent runtime security, posture and AI red teaming integration","approved_connector"),
    ("Lakera Guard / Check Point AI Guardrails","AI Security","Prompt injection, jailbreak and data-leakage runtime defense","approved_connector"),
    ("TrojAI","AI Security","Model vulnerability and adversarial stress-testing integration","approved_connector"),
    ("CalypsoAI / F5 AI Security","AI Security","Inference-layer AI security and guardrails integration","approved_connector"),
    ...
    ("Adversarial Robustness Toolbox","AI Security","ML adversarial robustness testing","isolated_ai_worker"),
    ("NeMo Guardrails","AI Security","LLM guardrails/policy enforcement","approved_worker"),
    ("Robust Intelligence","AI Security","AI security/validation platform integration","approved_connector"),
    ("HiddenLayer","AI Security","AI model security platform integration","approved_connector"),
]
