...
export const GROUPED_NAV = [
  ...
  ['RAG FABRIC · AGENTIC RAG PROJECT', [
    ['RAG · Overview', Brain],
    ['RAG · Sources', Database],
    ['RAG · Chunks', Database],
    ['RAG · Permissions', LockKeyhole],
    ['RAG · Users', Users],
    ['RAG · Duplicates', GitBranch],
    ['RAG · Pipeline', Activity],
    ['RAG · Metrics', Activity],
    ['RAG · Security', ShieldCheck],
    ['RAG · Architecture', Network],
    ['RAG · Native Admin', Globe],
  ]],
